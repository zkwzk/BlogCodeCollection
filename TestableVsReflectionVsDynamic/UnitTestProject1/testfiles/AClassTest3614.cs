...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3614
    {
        ...
        private AClassTestable3614 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3614(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3614 : AClass
    {
        public AClassTestable3614(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
