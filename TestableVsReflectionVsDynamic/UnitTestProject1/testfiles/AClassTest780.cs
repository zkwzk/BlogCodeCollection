...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest780
    {
        ...
        private AClassTestable780 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable780(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable780 : AClass
    {
        public AClassTestable780(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
