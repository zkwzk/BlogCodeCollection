...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest627
    {
        ...
        private AClassTestable627 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable627(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable627 : AClass
    {
        public AClassTestable627(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
