...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3279
    {
        ...
        private AClassTestable3279 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3279(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3279 : AClass
    {
        public AClassTestable3279(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
