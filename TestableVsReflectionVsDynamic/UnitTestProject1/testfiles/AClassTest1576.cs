...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1576
    {
        ...
        private AClassTestable1576 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1576(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1576 : AClass
    {
        public AClassTestable1576(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
