...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest439
    {
        ...
        private AClassTestable439 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable439(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable439 : AClass
    {
        public AClassTestable439(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
