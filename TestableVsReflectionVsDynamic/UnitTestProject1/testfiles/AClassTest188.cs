...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest188
    {
        ...
        private AClassTestable188 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable188(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable188 : AClass
    {
        public AClassTestable188(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
