...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest525
    {
        ...
        private AClassTestable525 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable525(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable525 : AClass
    {
        public AClassTestable525(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
