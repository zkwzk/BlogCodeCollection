...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest770
    {
        ...
        private AClassTestable770 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable770(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable770 : AClass
    {
        public AClassTestable770(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
