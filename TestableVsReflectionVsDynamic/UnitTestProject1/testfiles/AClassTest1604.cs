...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1604
    {
        ...
        private AClassTestable1604 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1604(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1604 : AClass
    {
        public AClassTestable1604(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
