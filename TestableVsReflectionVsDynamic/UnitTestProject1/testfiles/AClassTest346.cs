...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest346
    {
        ...
        private AClassTestable346 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable346(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable346 : AClass
    {
        public AClassTestable346(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
