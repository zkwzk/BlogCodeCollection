...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1593
    {
        ...
        private AClassTestable1593 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1593(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1593 : AClass
    {
        public AClassTestable1593(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
