...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3615
    {
        ...
        private AClassTestable3615 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3615(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3615 : AClass
    {
        public AClassTestable3615(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
