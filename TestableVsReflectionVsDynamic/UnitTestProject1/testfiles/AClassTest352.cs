...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest352
    {
        ...
        private AClassTestable352 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable352(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable352 : AClass
    {
        public AClassTestable352(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
