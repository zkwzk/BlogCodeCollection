...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest861
    {
        ...
        private AClassTestable861 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable861(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable861 : AClass
    {
        public AClassTestable861(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
