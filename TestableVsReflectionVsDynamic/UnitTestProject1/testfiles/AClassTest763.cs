...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest763
    {
        ...
        private AClassTestable763 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable763(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable763 : AClass
    {
        public AClassTestable763(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
