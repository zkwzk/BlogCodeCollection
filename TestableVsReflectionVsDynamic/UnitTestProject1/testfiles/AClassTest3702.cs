...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3702
    {
        ...
        private AClassTestable3702 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3702(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3702 : AClass
    {
        public AClassTestable3702(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
