...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest926
    {
        ...
        private AClassTestable926 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable926(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable926 : AClass
    {
        public AClassTestable926(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
