...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest597
    {
        ...
        private AClassTestable597 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable597(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable597 : AClass
    {
        public AClassTestable597(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
