...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3560
    {
        ...
        private AClassTestable3560 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3560(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3560 : AClass
    {
        public AClassTestable3560(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
