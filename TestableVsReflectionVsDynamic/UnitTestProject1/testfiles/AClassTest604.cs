...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest604
    {
        ...
        private AClassTestable604 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable604(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable604 : AClass
    {
        public AClassTestable604(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
