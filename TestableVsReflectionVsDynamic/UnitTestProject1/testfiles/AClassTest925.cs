...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest925
    {
        ...
        private AClassTestable925 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable925(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable925 : AClass
    {
        public AClassTestable925(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
