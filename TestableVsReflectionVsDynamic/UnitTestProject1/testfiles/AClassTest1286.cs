...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1286
    {
        ...
        private AClassTestable1286 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1286(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1286 : AClass
    {
        public AClassTestable1286(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
