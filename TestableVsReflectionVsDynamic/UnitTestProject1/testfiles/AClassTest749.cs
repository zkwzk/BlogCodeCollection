...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest749
    {
        ...
        private AClassTestable749 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable749(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable749 : AClass
    {
        public AClassTestable749(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
