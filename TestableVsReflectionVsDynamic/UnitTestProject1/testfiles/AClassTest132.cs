...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest132
    {
        ...
        private AClassTestable132 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable132(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable132 : AClass
    {
        public AClassTestable132(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
