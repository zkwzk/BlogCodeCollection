...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1959
    {
        ...
        private AClassTestable1959 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1959(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1959 : AClass
    {
        public AClassTestable1959(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
