...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3096
    {
        ...
        private AClassTestable3096 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3096(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3096 : AClass
    {
        public AClassTestable3096(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
