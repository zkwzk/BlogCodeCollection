...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3961
    {
        ...
        private AClassTestable3961 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3961(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3961 : AClass
    {
        public AClassTestable3961(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
