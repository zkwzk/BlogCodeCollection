...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1356
    {
        ...
        private AClassTestable1356 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1356(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1356 : AClass
    {
        public AClassTestable1356(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
