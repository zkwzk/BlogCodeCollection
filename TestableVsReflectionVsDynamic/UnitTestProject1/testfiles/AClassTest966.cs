...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest966
    {
        ...
        private AClassTestable966 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable966(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable966 : AClass
    {
        public AClassTestable966(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
