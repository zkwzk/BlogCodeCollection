...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3783
    {
        ...
        private AClassTestable3783 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3783(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3783 : AClass
    {
        public AClassTestable3783(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
