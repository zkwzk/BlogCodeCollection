...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3303
    {
        ...
        private AClassTestable3303 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3303(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3303 : AClass
    {
        public AClassTestable3303(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
