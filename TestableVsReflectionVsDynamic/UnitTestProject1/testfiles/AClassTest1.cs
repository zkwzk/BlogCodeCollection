...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1
    {
        ...
        private AClassTestable1 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1 : AClass
    {
        public AClassTestable1(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
