...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest834
    {
        ...
        private AClassTestable834 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable834(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable834 : AClass
    {
        public AClassTestable834(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
