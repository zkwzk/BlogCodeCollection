...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1740
    {
        ...
        private AClassTestable1740 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1740(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1740 : AClass
    {
        public AClassTestable1740(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
