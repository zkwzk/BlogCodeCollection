...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3247
    {
        ...
        private AClassTestable3247 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3247(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3247 : AClass
    {
        public AClassTestable3247(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
