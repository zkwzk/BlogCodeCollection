...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3076
    {
        ...
        private AClassTestable3076 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3076(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3076 : AClass
    {
        public AClassTestable3076(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
