...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1942
    {
        ...
        private AClassTestable1942 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1942(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1942 : AClass
    {
        public AClassTestable1942(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
