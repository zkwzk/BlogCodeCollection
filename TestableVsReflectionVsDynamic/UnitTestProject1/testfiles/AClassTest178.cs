...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest178
    {
        ...
        private AClassTestable178 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable178(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable178 : AClass
    {
        public AClassTestable178(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
