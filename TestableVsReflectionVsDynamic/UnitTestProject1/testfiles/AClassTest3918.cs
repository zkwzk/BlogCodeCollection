...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3918
    {
        ...
        private AClassTestable3918 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3918(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3918 : AClass
    {
        public AClassTestable3918(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
