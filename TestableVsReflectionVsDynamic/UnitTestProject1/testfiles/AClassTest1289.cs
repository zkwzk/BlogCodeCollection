...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1289
    {
        ...
        private AClassTestable1289 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1289(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1289 : AClass
    {
        public AClassTestable1289(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
