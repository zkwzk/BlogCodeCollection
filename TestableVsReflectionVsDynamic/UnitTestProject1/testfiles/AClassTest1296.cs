...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1296
    {
        ...
        private AClassTestable1296 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1296(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1296 : AClass
    {
        public AClassTestable1296(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
