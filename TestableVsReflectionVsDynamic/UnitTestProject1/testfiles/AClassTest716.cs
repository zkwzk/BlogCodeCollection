...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest716
    {
        ...
        private AClassTestable716 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable716(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable716 : AClass
    {
        public AClassTestable716(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
