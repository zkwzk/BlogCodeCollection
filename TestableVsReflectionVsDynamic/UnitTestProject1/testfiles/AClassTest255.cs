...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest255
    {
        ...
        private AClassTestable255 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable255(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable255 : AClass
    {
        public AClassTestable255(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
