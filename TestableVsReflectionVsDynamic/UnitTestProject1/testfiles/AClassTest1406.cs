...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1406
    {
        ...
        private AClassTestable1406 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1406(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1406 : AClass
    {
        public AClassTestable1406(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
