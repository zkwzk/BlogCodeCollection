...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3712
    {
        ...
        private AClassTestable3712 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3712(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3712 : AClass
    {
        public AClassTestable3712(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
