...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest610
    {
        ...
        private AClassTestable610 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable610(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable610 : AClass
    {
        public AClassTestable610(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
