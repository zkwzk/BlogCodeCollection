...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1692
    {
        ...
        private AClassTestable1692 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1692(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1692 : AClass
    {
        public AClassTestable1692(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
