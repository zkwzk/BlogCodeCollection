...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3273
    {
        ...
        private AClassTestable3273 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3273(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3273 : AClass
    {
        public AClassTestable3273(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
