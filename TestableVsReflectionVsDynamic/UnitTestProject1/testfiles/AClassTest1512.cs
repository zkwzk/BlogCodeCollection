...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1512
    {
        ...
        private AClassTestable1512 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1512(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1512 : AClass
    {
        public AClassTestable1512(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
