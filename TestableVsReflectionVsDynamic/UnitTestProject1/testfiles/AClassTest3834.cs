...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3834
    {
        ...
        private AClassTestable3834 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3834(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3834 : AClass
    {
        public AClassTestable3834(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
