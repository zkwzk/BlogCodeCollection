...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3448
    {
        ...
        private AClassTestable3448 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3448(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3448 : AClass
    {
        public AClassTestable3448(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
