...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest944
    {
        ...
        private AClassTestable944 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable944(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable944 : AClass
    {
        public AClassTestable944(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
