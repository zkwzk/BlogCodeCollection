...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest148
    {
        ...
        private AClassTestable148 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable148(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable148 : AClass
    {
        public AClassTestable148(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
