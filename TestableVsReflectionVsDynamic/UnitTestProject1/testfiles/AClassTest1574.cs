...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1574
    {
        ...
        private AClassTestable1574 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1574(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1574 : AClass
    {
        public AClassTestable1574(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
