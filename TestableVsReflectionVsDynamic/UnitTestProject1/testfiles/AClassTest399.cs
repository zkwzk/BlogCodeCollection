...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest399
    {
        ...
        private AClassTestable399 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable399(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable399 : AClass
    {
        public AClassTestable399(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
