...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3903
    {
        ...
        private AClassTestable3903 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3903(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3903 : AClass
    {
        public AClassTestable3903(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
