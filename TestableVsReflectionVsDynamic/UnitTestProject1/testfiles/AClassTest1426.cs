...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1426
    {
        ...
        private AClassTestable1426 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1426(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1426 : AClass
    {
        public AClassTestable1426(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
