...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest737
    {
        ...
        private AClassTestable737 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable737(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable737 : AClass
    {
        public AClassTestable737(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
