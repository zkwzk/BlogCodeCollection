...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3542
    {
        ...
        private AClassTestable3542 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3542(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3542 : AClass
    {
        public AClassTestable3542(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
