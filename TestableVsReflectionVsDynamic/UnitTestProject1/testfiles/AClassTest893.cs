...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest893
    {
        ...
        private AClassTestable893 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable893(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable893 : AClass
    {
        public AClassTestable893(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
