...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest405
    {
        ...
        private AClassTestable405 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable405(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable405 : AClass
    {
        public AClassTestable405(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
