...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest144
    {
        ...
        private AClassTestable144 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable144(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable144 : AClass
    {
        public AClassTestable144(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
