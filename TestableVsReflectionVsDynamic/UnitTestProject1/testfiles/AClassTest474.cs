...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest474
    {
        ...
        private AClassTestable474 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable474(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable474 : AClass
    {
        public AClassTestable474(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
