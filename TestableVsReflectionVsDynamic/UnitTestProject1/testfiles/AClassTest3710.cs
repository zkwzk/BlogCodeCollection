...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3710
    {
        ...
        private AClassTestable3710 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3710(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3710 : AClass
    {
        public AClassTestable3710(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
