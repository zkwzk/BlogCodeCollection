...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest182
    {
        ...
        private AClassTestable182 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable182(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable182 : AClass
    {
        public AClassTestable182(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
