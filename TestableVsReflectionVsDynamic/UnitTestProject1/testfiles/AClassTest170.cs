...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest170
    {
        ...
        private AClassTestable170 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable170(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable170 : AClass
    {
        public AClassTestable170(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
