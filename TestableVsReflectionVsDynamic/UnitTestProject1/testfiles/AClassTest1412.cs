...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1412
    {
        ...
        private AClassTestable1412 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1412(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1412 : AClass
    {
        public AClassTestable1412(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
