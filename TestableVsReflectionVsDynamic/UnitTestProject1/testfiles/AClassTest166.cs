...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest166
    {
        ...
        private AClassTestable166 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable166(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable166 : AClass
    {
        public AClassTestable166(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
