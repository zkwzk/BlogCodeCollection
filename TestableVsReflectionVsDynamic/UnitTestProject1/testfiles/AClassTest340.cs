...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest340
    {
        ...
        private AClassTestable340 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable340(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable340 : AClass
    {
        public AClassTestable340(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
