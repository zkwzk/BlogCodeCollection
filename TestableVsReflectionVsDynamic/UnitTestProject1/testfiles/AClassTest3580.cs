...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3580
    {
        ...
        private AClassTestable3580 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3580(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3580 : AClass
    {
        public AClassTestable3580(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
