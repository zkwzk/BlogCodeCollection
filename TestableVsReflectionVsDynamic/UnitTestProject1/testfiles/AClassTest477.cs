...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest477
    {
        ...
        private AClassTestable477 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable477(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable477 : AClass
    {
        public AClassTestable477(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
