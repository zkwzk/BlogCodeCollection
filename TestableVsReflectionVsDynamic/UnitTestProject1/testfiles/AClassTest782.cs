...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest782
    {
        ...
        private AClassTestable782 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable782(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable782 : AClass
    {
        public AClassTestable782(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
