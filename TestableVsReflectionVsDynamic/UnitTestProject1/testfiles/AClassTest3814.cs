...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3814
    {
        ...
        private AClassTestable3814 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3814(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3814 : AClass
    {
        public AClassTestable3814(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
