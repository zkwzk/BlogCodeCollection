...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest573
    {
        ...
        private AClassTestable573 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable573(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable573 : AClass
    {
        public AClassTestable573(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
