...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest389
    {
        ...
        private AClassTestable389 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable389(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable389 : AClass
    {
        public AClassTestable389(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
