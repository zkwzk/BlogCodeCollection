...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1561
    {
        ...
        private AClassTestable1561 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1561(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1561 : AClass
    {
        public AClassTestable1561(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
