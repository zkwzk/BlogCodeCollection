...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest522
    {
        ...
        private AClassTestable522 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable522(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable522 : AClass
    {
        public AClassTestable522(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
