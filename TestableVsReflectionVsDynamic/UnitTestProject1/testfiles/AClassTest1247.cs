...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1247
    {
        ...
        private AClassTestable1247 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1247(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1247 : AClass
    {
        public AClassTestable1247(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
