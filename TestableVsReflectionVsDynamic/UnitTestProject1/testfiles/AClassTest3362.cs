...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3362
    {
        ...
        private AClassTestable3362 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3362(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3362 : AClass
    {
        public AClassTestable3362(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
