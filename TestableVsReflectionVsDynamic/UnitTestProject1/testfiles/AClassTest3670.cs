...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3670
    {
        ...
        private AClassTestable3670 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3670(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3670 : AClass
    {
        public AClassTestable3670(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
