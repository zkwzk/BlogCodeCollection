...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest463
    {
        ...
        private AClassTestable463 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable463(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable463 : AClass
    {
        public AClassTestable463(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
