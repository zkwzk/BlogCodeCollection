...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3765
    {
        ...
        private AClassTestable3765 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3765(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3765 : AClass
    {
        public AClassTestable3765(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
