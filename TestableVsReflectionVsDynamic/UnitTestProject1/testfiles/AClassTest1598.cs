...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1598
    {
        ...
        private AClassTestable1598 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1598(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1598 : AClass
    {
        public AClassTestable1598(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
