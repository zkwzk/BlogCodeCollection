...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest108
    {
        ...
        private AClassTestable108 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable108(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable108 : AClass
    {
        public AClassTestable108(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
