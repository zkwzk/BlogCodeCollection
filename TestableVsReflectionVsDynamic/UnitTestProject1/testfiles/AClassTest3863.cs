...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3863
    {
        ...
        private AClassTestable3863 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3863(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3863 : AClass
    {
        public AClassTestable3863(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
