...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1365
    {
        ...
        private AClassTestable1365 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1365(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1365 : AClass
    {
        public AClassTestable1365(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
