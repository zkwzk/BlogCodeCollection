...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest892
    {
        ...
        private AClassTestable892 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable892(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable892 : AClass
    {
        public AClassTestable892(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
