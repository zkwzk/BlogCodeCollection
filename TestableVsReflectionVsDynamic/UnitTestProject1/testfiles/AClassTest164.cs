...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest164
    {
        ...
        private AClassTestable164 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable164(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable164 : AClass
    {
        public AClassTestable164(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
