...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest299
    {
        ...
        private AClassTestable299 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable299(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable299 : AClass
    {
        public AClassTestable299(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
