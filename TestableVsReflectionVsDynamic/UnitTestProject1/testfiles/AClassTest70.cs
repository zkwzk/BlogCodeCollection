...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest70
    {
        ...
        private AClassTestable70 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable70(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable70 : AClass
    {
        public AClassTestable70(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
