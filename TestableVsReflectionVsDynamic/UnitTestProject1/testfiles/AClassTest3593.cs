...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3593
    {
        ...
        private AClassTestable3593 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3593(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3593 : AClass
    {
        public AClassTestable3593(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
