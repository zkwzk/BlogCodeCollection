...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1248
    {
        ...
        private AClassTestable1248 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1248(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1248 : AClass
    {
        public AClassTestable1248(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
