...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3286
    {
        ...
        private AClassTestable3286 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3286(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3286 : AClass
    {
        public AClassTestable3286(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
