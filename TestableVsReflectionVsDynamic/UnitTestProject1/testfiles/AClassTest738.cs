...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest738
    {
        ...
        private AClassTestable738 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable738(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable738 : AClass
    {
        public AClassTestable738(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
