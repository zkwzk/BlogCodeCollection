...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3841
    {
        ...
        private AClassTestable3841 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3841(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3841 : AClass
    {
        public AClassTestable3841(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
