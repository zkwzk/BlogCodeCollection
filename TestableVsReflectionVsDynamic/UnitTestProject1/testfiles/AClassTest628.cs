...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest628
    {
        ...
        private AClassTestable628 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable628(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable628 : AClass
    {
        public AClassTestable628(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
