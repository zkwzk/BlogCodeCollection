...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3281
    {
        ...
        private AClassTestable3281 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3281(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3281 : AClass
    {
        public AClassTestable3281(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
