...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest689
    {
        ...
        private AClassTestable689 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable689(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable689 : AClass
    {
        public AClassTestable689(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
