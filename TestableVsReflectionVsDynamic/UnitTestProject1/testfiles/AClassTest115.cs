...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest115
    {
        ...
        private AClassTestable115 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable115(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable115 : AClass
    {
        public AClassTestable115(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
