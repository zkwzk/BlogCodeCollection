...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3716
    {
        ...
        private AClassTestable3716 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3716(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3716 : AClass
    {
        public AClassTestable3716(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
