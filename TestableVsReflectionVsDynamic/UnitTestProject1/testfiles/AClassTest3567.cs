...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3567
    {
        ...
        private AClassTestable3567 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3567(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3567 : AClass
    {
        public AClassTestable3567(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
