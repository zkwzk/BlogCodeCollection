...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest196
    {
        ...
        private AClassTestable196 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable196(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable196 : AClass
    {
        public AClassTestable196(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
