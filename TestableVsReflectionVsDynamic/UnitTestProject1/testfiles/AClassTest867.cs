...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest867
    {
        ...
        private AClassTestable867 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable867(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable867 : AClass
    {
        public AClassTestable867(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
