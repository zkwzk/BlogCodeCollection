...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest189
    {
        ...
        private AClassTestable189 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable189(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable189 : AClass
    {
        public AClassTestable189(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
