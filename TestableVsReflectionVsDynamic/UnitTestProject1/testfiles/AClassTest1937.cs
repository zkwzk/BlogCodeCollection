...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1937
    {
        ...
        private AClassTestable1937 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1937(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1937 : AClass
    {
        public AClassTestable1937(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
