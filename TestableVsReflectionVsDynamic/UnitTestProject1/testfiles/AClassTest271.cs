...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest271
    {
        ...
        private AClassTestable271 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable271(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable271 : AClass
    {
        public AClassTestable271(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
