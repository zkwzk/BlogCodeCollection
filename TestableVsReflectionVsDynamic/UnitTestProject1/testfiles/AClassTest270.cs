...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest270
    {
        ...
        private AClassTestable270 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable270(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable270 : AClass
    {
        public AClassTestable270(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
