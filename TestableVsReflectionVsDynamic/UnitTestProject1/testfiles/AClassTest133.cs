...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest133
    {
        ...
        private AClassTestable133 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable133(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable133 : AClass
    {
        public AClassTestable133(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
