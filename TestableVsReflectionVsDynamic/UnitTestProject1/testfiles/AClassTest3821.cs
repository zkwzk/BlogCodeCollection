...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3821
    {
        ...
        private AClassTestable3821 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3821(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3821 : AClass
    {
        public AClassTestable3821(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
