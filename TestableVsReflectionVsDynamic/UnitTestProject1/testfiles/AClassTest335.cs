...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest335
    {
        ...
        private AClassTestable335 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable335(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable335 : AClass
    {
        public AClassTestable335(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
