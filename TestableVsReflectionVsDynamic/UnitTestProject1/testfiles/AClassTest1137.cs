...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1137
    {
        ...
        private AClassTestable1137 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1137(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1137 : AClass
    {
        public AClassTestable1137(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
