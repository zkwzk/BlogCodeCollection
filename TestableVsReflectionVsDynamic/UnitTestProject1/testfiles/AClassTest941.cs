...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest941
    {
        ...
        private AClassTestable941 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable941(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable941 : AClass
    {
        public AClassTestable941(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
