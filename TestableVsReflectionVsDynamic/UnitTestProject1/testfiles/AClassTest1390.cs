...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1390
    {
        ...
        private AClassTestable1390 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1390(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1390 : AClass
    {
        public AClassTestable1390(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
