...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest210
    {
        ...
        private AClassTestable210 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable210(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable210 : AClass
    {
        public AClassTestable210(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
