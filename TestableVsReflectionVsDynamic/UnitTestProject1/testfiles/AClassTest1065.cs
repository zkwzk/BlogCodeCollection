...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1065
    {
        ...
        private AClassTestable1065 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1065(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1065 : AClass
    {
        public AClassTestable1065(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
