...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1849
    {
        ...
        private AClassTestable1849 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1849(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1849 : AClass
    {
        public AClassTestable1849(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
