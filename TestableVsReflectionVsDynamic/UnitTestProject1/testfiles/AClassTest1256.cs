...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1256
    {
        ...
        private AClassTestable1256 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1256(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1256 : AClass
    {
        public AClassTestable1256(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
