...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest470
    {
        ...
        private AClassTestable470 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable470(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable470 : AClass
    {
        public AClassTestable470(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
