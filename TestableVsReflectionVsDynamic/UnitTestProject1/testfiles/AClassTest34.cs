...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest34
    {
        ...
        private AClassTestable34 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable34(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable34 : AClass
    {
        public AClassTestable34(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
