...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest432
    {
        ...
        private AClassTestable432 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable432(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable432 : AClass
    {
        public AClassTestable432(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
