...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest331
    {
        ...
        private AClassTestable331 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable331(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable331 : AClass
    {
        public AClassTestable331(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
