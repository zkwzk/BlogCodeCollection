...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1255
    {
        ...
        private AClassTestable1255 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1255(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1255 : AClass
    {
        public AClassTestable1255(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
