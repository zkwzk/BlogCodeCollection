...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest64
    {
        ...
        private AClassTestable64 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable64(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable64 : AClass
    {
        public AClassTestable64(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
