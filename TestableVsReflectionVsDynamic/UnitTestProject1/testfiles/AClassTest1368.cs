...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1368
    {
        ...
        private AClassTestable1368 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1368(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1368 : AClass
    {
        public AClassTestable1368(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
