...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest174
    {
        ...
        private AClassTestable174 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable174(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable174 : AClass
    {
        public AClassTestable174(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
