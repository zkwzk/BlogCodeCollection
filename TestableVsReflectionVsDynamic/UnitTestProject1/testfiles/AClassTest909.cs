...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest909
    {
        ...
        private AClassTestable909 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable909(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable909 : AClass
    {
        public AClassTestable909(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
