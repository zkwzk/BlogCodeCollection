...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1932
    {
        ...
        private AClassTestable1932 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1932(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1932 : AClass
    {
        public AClassTestable1932(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
