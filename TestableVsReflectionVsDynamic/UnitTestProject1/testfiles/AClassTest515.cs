...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest515
    {
        ...
        private AClassTestable515 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable515(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable515 : AClass
    {
        public AClassTestable515(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
