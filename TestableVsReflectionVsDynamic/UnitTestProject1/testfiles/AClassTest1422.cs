...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1422
    {
        ...
        private AClassTestable1422 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1422(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1422 : AClass
    {
        public AClassTestable1422(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
