...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3917
    {
        ...
        private AClassTestable3917 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3917(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3917 : AClass
    {
        public AClassTestable3917(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
