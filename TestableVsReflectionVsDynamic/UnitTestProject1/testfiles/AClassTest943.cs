...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest943
    {
        ...
        private AClassTestable943 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable943(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable943 : AClass
    {
        public AClassTestable943(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
