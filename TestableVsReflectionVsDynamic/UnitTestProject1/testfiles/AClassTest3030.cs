...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3030
    {
        ...
        private AClassTestable3030 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3030(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3030 : AClass
    {
        public AClassTestable3030(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
