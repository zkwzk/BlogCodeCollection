...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1430
    {
        ...
        private AClassTestable1430 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1430(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1430 : AClass
    {
        public AClassTestable1430(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
