...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1627
    {
        ...
        private AClassTestable1627 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1627(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1627 : AClass
    {
        public AClassTestable1627(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
