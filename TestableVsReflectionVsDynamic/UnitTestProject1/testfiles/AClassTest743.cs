...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest743
    {
        ...
        private AClassTestable743 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable743(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable743 : AClass
    {
        public AClassTestable743(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
