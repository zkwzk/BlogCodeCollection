...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest239
    {
        ...
        private AClassTestable239 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable239(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable239 : AClass
    {
        public AClassTestable239(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
