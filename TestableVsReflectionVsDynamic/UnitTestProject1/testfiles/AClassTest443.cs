...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest443
    {
        ...
        private AClassTestable443 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable443(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable443 : AClass
    {
        public AClassTestable443(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
