...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest533
    {
        ...
        private AClassTestable533 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable533(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable533 : AClass
    {
        public AClassTestable533(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
