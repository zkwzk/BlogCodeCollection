...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3582
    {
        ...
        private AClassTestable3582 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3582(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3582 : AClass
    {
        public AClassTestable3582(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
