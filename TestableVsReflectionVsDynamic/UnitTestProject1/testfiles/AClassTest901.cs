...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest901
    {
        ...
        private AClassTestable901 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable901(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable901 : AClass
    {
        public AClassTestable901(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
