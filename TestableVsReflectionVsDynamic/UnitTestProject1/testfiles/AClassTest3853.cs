...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3853
    {
        ...
        private AClassTestable3853 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3853(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3853 : AClass
    {
        public AClassTestable3853(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
