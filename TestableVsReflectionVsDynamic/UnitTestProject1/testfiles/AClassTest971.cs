...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest971
    {
        ...
        private AClassTestable971 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable971(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable971 : AClass
    {
        public AClassTestable971(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
