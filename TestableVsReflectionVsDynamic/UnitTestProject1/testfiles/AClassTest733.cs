...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest733
    {
        ...
        private AClassTestable733 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable733(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable733 : AClass
    {
        public AClassTestable733(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
