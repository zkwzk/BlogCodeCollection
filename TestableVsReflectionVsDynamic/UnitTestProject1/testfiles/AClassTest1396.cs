...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1396
    {
        ...
        private AClassTestable1396 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1396(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1396 : AClass
    {
        public AClassTestable1396(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
