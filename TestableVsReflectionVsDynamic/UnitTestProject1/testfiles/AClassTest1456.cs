...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1456
    {
        ...
        private AClassTestable1456 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1456(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1456 : AClass
    {
        public AClassTestable1456(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
