...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3860
    {
        ...
        private AClassTestable3860 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3860(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3860 : AClass
    {
        public AClassTestable3860(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
