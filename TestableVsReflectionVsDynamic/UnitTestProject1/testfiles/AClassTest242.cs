...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest242
    {
        ...
        private AClassTestable242 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable242(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable242 : AClass
    {
        public AClassTestable242(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
