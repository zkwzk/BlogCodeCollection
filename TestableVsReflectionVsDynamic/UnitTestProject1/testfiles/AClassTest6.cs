...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest6
    {
        ...
        private AClassTestable6 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable6(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable6 : AClass
    {
        public AClassTestable6(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
