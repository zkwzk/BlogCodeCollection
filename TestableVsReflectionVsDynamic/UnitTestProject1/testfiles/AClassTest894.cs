...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest894
    {
        ...
        private AClassTestable894 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable894(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable894 : AClass
    {
        public AClassTestable894(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
