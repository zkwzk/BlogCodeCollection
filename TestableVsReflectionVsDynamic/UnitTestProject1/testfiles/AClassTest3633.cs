...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3633
    {
        ...
        private AClassTestable3633 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3633(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3633 : AClass
    {
        public AClassTestable3633(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
