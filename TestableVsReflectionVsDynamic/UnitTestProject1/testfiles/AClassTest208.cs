...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest208
    {
        ...
        private AClassTestable208 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable208(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable208 : AClass
    {
        public AClassTestable208(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
