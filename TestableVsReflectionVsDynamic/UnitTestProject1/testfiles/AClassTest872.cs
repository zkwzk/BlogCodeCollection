...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest872
    {
        ...
        private AClassTestable872 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable872(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable872 : AClass
    {
        public AClassTestable872(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
