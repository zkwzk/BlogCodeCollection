...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest383
    {
        ...
        private AClassTestable383 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable383(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable383 : AClass
    {
        public AClassTestable383(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
