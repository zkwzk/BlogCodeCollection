...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest624
    {
        ...
        private AClassTestable624 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable624(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable624 : AClass
    {
        public AClassTestable624(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
