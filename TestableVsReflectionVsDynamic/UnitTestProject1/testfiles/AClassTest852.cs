...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest852
    {
        ...
        private AClassTestable852 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable852(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable852 : AClass
    {
        public AClassTestable852(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
