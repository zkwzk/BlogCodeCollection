...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest752
    {
        ...
        private AClassTestable752 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable752(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable752 : AClass
    {
        public AClassTestable752(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
