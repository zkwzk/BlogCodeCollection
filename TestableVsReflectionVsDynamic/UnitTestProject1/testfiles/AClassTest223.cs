...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest223
    {
        ...
        private AClassTestable223 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable223(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable223 : AClass
    {
        public AClassTestable223(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
