...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest729
    {
        ...
        private AClassTestable729 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable729(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable729 : AClass
    {
        public AClassTestable729(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
