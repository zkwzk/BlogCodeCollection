...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1970
    {
        ...
        private AClassTestable1970 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1970(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1970 : AClass
    {
        public AClassTestable1970(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
