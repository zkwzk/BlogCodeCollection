...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest613
    {
        ...
        private AClassTestable613 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable613(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable613 : AClass
    {
        public AClassTestable613(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
