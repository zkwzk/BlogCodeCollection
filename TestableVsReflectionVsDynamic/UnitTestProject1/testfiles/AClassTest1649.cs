...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1649
    {
        ...
        private AClassTestable1649 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1649(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1649 : AClass
    {
        public AClassTestable1649(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
