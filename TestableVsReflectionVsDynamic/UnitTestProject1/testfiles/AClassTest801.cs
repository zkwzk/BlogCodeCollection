...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest801
    {
        ...
        private AClassTestable801 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable801(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable801 : AClass
    {
        public AClassTestable801(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
