...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1101
    {
        ...
        private AClassTestable1101 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1101(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1101 : AClass
    {
        public AClassTestable1101(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
