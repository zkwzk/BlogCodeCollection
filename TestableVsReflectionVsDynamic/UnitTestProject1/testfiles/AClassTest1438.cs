...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1438
    {
        ...
        private AClassTestable1438 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1438(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1438 : AClass
    {
        public AClassTestable1438(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
