...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1100
    {
        ...
        private AClassTestable1100 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1100(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1100 : AClass
    {
        public AClassTestable1100(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
