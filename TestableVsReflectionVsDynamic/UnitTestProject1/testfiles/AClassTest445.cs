...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest445
    {
        ...
        private AClassTestable445 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable445(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable445 : AClass
    {
        public AClassTestable445(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
