...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1242
    {
        ...
        private AClassTestable1242 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1242(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1242 : AClass
    {
        public AClassTestable1242(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
