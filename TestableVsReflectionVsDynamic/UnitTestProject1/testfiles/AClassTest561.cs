...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest561
    {
        ...
        private AClassTestable561 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable561(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable561 : AClass
    {
        public AClassTestable561(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
