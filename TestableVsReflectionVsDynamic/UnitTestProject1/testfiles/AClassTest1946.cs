...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1946
    {
        ...
        private AClassTestable1946 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1946(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1946 : AClass
    {
        public AClassTestable1946(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
