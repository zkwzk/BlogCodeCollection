...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest823
    {
        ...
        private AClassTestable823 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable823(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable823 : AClass
    {
        public AClassTestable823(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
