...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest420
    {
        ...
        private AClassTestable420 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable420(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable420 : AClass
    {
        public AClassTestable420(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
