...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest105
    {
        ...
        private AClassTestable105 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable105(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable105 : AClass
    {
        public AClassTestable105(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
