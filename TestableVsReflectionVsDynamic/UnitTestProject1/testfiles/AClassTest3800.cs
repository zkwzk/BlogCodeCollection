...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3800
    {
        ...
        private AClassTestable3800 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3800(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3800 : AClass
    {
        public AClassTestable3800(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
