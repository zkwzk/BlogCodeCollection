...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest620
    {
        ...
        private AClassTestable620 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable620(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable620 : AClass
    {
        public AClassTestable620(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
