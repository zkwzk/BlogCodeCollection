...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1864
    {
        ...
        private AClassTestable1864 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1864(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1864 : AClass
    {
        public AClassTestable1864(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
