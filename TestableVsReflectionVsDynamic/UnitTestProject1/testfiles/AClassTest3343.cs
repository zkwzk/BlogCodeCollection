...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3343
    {
        ...
        private AClassTestable3343 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3343(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3343 : AClass
    {
        public AClassTestable3343(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
