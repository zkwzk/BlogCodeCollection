...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest661
    {
        ...
        private AClassTestable661 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable661(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable661 : AClass
    {
        public AClassTestable661(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
