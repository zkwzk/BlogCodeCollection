...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest937
    {
        ...
        private AClassTestable937 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable937(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable937 : AClass
    {
        public AClassTestable937(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
