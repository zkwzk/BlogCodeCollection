...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest570
    {
        ...
        private AClassTestable570 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable570(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable570 : AClass
    {
        public AClassTestable570(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
