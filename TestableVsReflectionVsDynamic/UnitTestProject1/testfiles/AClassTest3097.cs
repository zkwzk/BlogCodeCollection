...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3097
    {
        ...
        private AClassTestable3097 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3097(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3097 : AClass
    {
        public AClassTestable3097(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
