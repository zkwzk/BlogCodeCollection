...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3
    {
        ...
        private AClassTestable3 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3 : AClass
    {
        public AClassTestable3(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
