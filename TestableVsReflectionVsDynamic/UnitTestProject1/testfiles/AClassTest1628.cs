...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1628
    {
        ...
        private AClassTestable1628 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1628(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1628 : AClass
    {
        public AClassTestable1628(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
