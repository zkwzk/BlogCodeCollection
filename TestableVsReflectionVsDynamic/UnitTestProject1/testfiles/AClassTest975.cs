...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest975
    {
        ...
        private AClassTestable975 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable975(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable975 : AClass
    {
        public AClassTestable975(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
