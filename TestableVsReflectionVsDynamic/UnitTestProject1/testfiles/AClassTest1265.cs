...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1265
    {
        ...
        private AClassTestable1265 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1265(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1265 : AClass
    {
        public AClassTestable1265(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
