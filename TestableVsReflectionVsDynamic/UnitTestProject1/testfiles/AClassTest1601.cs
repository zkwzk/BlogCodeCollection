...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1601
    {
        ...
        private AClassTestable1601 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1601(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1601 : AClass
    {
        public AClassTestable1601(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
