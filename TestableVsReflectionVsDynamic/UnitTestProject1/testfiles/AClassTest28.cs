...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest28
    {
        ...
        private AClassTestable28 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable28(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable28 : AClass
    {
        public AClassTestable28(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
