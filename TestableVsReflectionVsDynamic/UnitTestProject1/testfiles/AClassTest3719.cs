...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3719
    {
        ...
        private AClassTestable3719 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3719(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3719 : AClass
    {
        public AClassTestable3719(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
