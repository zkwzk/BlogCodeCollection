...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest317
    {
        ...
        private AClassTestable317 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable317(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable317 : AClass
    {
        public AClassTestable317(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
