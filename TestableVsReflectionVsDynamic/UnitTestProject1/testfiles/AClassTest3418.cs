...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3418
    {
        ...
        private AClassTestable3418 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3418(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3418 : AClass
    {
        public AClassTestable3418(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
