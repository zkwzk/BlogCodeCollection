...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest396
    {
        ...
        private AClassTestable396 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable396(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable396 : AClass
    {
        public AClassTestable396(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
