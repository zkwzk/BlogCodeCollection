...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest92
    {
        ...
        private AClassTestable92 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable92(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable92 : AClass
    {
        public AClassTestable92(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
