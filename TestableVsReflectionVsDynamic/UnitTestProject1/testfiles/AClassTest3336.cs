...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3336
    {
        ...
        private AClassTestable3336 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3336(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3336 : AClass
    {
        public AClassTestable3336(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
