...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest288
    {
        ...
        private AClassTestable288 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable288(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable288 : AClass
    {
        public AClassTestable288(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
