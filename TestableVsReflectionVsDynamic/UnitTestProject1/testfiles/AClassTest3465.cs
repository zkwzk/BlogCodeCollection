...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3465
    {
        ...
        private AClassTestable3465 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3465(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3465 : AClass
    {
        public AClassTestable3465(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
