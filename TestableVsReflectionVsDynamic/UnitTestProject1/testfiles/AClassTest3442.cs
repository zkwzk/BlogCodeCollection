...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3442
    {
        ...
        private AClassTestable3442 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3442(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3442 : AClass
    {
        public AClassTestable3442(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
