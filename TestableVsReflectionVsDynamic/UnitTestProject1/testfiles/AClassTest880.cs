...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest880
    {
        ...
        private AClassTestable880 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable880(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable880 : AClass
    {
        public AClassTestable880(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
