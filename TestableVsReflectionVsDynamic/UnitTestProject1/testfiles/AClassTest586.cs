...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest586
    {
        ...
        private AClassTestable586 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable586(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable586 : AClass
    {
        public AClassTestable586(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
