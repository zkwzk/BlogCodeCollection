...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest791
    {
        ...
        private AClassTestable791 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable791(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable791 : AClass
    {
        public AClassTestable791(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
