...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest32
    {
        ...
        private AClassTestable32 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable32(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable32 : AClass
    {
        public AClassTestable32(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
