...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1913
    {
        ...
        private AClassTestable1913 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1913(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1913 : AClass
    {
        public AClassTestable1913(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
