...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1338
    {
        ...
        private AClassTestable1338 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1338(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1338 : AClass
    {
        public AClassTestable1338(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
