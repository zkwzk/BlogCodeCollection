...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest142
    {
        ...
        private AClassTestable142 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable142(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable142 : AClass
    {
        public AClassTestable142(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
