...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest217
    {
        ...
        private AClassTestable217 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable217(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable217 : AClass
    {
        public AClassTestable217(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
