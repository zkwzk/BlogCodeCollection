...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest731
    {
        ...
        private AClassTestable731 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable731(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable731 : AClass
    {
        public AClassTestable731(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
