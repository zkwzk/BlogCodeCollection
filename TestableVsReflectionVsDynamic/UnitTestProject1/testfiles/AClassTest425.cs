...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest425
    {
        ...
        private AClassTestable425 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable425(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable425 : AClass
    {
        public AClassTestable425(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
