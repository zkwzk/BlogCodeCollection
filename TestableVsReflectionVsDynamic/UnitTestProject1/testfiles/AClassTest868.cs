...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest868
    {
        ...
        private AClassTestable868 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable868(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable868 : AClass
    {
        public AClassTestable868(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
