...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest674
    {
        ...
        private AClassTestable674 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable674(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable674 : AClass
    {
        public AClassTestable674(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
