...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest131
    {
        ...
        private AClassTestable131 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable131(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable131 : AClass
    {
        public AClassTestable131(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
