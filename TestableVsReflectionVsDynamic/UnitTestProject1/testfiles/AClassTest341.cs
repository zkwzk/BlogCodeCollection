...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest341
    {
        ...
        private AClassTestable341 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable341(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable341 : AClass
    {
        public AClassTestable341(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
