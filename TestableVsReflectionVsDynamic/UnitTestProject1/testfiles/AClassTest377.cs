...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest377
    {
        ...
        private AClassTestable377 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable377(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable377 : AClass
    {
        public AClassTestable377(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
