...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest231
    {
        ...
        private AClassTestable231 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable231(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable231 : AClass
    {
        public AClassTestable231(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
