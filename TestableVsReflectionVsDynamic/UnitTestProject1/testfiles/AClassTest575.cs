...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest575
    {
        ...
        private AClassTestable575 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable575(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable575 : AClass
    {
        public AClassTestable575(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
