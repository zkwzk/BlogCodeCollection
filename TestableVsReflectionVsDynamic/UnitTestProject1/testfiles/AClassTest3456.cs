...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3456
    {
        ...
        private AClassTestable3456 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3456(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3456 : AClass
    {
        public AClassTestable3456(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
