...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1995
    {
        ...
        private AClassTestable1995 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1995(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1995 : AClass
    {
        public AClassTestable1995(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
