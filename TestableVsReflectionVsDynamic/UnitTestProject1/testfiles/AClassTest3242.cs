...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3242
    {
        ...
        private AClassTestable3242 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3242(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3242 : AClass
    {
        public AClassTestable3242(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
