...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3331
    {
        ...
        private AClassTestable3331 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3331(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3331 : AClass
    {
        public AClassTestable3331(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
