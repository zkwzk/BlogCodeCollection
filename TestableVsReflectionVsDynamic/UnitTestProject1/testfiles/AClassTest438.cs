...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest438
    {
        ...
        private AClassTestable438 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable438(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable438 : AClass
    {
        public AClassTestable438(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
