...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3470
    {
        ...
        private AClassTestable3470 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3470(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3470 : AClass
    {
        public AClassTestable3470(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
