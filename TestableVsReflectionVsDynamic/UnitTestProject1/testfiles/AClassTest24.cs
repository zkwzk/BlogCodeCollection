...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest24
    {
        ...
        private AClassTestable24 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable24(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable24 : AClass
    {
        public AClassTestable24(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
