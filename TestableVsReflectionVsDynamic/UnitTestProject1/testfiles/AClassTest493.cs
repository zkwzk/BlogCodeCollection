...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest493
    {
        ...
        private AClassTestable493 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable493(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable493 : AClass
    {
        public AClassTestable493(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
