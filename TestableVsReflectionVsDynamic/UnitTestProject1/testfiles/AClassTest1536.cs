...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1536
    {
        ...
        private AClassTestable1536 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1536(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1536 : AClass
    {
        public AClassTestable1536(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
