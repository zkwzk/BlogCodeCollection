...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3061
    {
        ...
        private AClassTestable3061 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3061(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3061 : AClass
    {
        public AClassTestable3061(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
