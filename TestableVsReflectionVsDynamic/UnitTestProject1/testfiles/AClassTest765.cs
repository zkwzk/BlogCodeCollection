...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest765
    {
        ...
        private AClassTestable765 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable765(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable765 : AClass
    {
        public AClassTestable765(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
