...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest642
    {
        ...
        private AClassTestable642 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable642(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable642 : AClass
    {
        public AClassTestable642(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
