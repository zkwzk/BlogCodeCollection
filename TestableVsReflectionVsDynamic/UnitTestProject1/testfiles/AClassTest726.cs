...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest726
    {
        ...
        private AClassTestable726 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable726(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable726 : AClass
    {
        public AClassTestable726(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
