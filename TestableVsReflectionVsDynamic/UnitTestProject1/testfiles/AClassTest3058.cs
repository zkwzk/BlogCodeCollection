...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3058
    {
        ...
        private AClassTestable3058 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3058(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3058 : AClass
    {
        public AClassTestable3058(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
