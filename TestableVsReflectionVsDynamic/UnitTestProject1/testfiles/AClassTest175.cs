...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest175
    {
        ...
        private AClassTestable175 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable175(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable175 : AClass
    {
        public AClassTestable175(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
