...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest710
    {
        ...
        private AClassTestable710 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable710(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable710 : AClass
    {
        public AClassTestable710(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
