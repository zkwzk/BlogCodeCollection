...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3216
    {
        ...
        private AClassTestable3216 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3216(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3216 : AClass
    {
        public AClassTestable3216(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
