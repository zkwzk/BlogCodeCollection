...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest820
    {
        ...
        private AClassTestable820 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable820(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable820 : AClass
    {
        public AClassTestable820(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
