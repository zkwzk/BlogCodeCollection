...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest687
    {
        ...
        private AClassTestable687 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable687(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable687 : AClass
    {
        public AClassTestable687(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
