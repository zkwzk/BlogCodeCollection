...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1823
    {
        ...
        private AClassTestable1823 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1823(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1823 : AClass
    {
        public AClassTestable1823(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
