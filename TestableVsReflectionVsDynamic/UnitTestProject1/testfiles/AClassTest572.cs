...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest572
    {
        ...
        private AClassTestable572 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable572(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable572 : AClass
    {
        public AClassTestable572(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
