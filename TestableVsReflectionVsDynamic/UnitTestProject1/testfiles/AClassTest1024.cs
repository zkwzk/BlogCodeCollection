...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1024
    {
        ...
        private AClassTestable1024 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1024(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1024 : AClass
    {
        public AClassTestable1024(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
