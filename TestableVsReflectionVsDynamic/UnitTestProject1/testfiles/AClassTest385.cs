...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest385
    {
        ...
        private AClassTestable385 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable385(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable385 : AClass
    {
        public AClassTestable385(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
