...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest410
    {
        ...
        private AClassTestable410 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable410(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable410 : AClass
    {
        public AClassTestable410(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
