...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3130
    {
        ...
        private AClassTestable3130 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3130(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3130 : AClass
    {
        public AClassTestable3130(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
