...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest921
    {
        ...
        private AClassTestable921 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable921(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable921 : AClass
    {
        public AClassTestable921(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
