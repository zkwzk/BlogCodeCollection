...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1635
    {
        ...
        private AClassTestable1635 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1635(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1635 : AClass
    {
        public AClassTestable1635(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
