...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3806
    {
        ...
        private AClassTestable3806 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3806(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3806 : AClass
    {
        public AClassTestable3806(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
