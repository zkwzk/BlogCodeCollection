...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest649
    {
        ...
        private AClassTestable649 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable649(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable649 : AClass
    {
        public AClassTestable649(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
