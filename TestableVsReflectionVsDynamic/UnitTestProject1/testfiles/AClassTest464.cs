...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest464
    {
        ...
        private AClassTestable464 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable464(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable464 : AClass
    {
        public AClassTestable464(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
