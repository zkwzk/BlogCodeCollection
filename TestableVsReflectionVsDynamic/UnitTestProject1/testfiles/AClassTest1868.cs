...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1868
    {
        ...
        private AClassTestable1868 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1868(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1868 : AClass
    {
        public AClassTestable1868(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
