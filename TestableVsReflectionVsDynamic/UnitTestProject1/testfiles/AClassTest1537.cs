...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1537
    {
        ...
        private AClassTestable1537 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1537(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1537 : AClass
    {
        public AClassTestable1537(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
