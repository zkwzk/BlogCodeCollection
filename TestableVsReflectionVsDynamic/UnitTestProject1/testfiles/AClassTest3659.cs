...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3659
    {
        ...
        private AClassTestable3659 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3659(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3659 : AClass
    {
        public AClassTestable3659(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
