...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1370
    {
        ...
        private AClassTestable1370 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1370(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1370 : AClass
    {
        public AClassTestable1370(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
