...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3090
    {
        ...
        private AClassTestable3090 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3090(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3090 : AClass
    {
        public AClassTestable3090(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
