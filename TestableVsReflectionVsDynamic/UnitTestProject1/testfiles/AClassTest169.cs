...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest169
    {
        ...
        private AClassTestable169 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable169(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable169 : AClass
    {
        public AClassTestable169(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
