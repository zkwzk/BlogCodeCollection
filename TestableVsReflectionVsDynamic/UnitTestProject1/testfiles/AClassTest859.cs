...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest859
    {
        ...
        private AClassTestable859 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable859(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable859 : AClass
    {
        public AClassTestable859(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
