...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3409
    {
        ...
        private AClassTestable3409 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3409(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3409 : AClass
    {
        public AClassTestable3409(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
