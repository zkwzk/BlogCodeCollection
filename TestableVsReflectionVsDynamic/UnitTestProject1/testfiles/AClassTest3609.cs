...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3609
    {
        ...
        private AClassTestable3609 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3609(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3609 : AClass
    {
        public AClassTestable3609(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
