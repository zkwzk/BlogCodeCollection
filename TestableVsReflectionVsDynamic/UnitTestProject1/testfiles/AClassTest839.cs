...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest839
    {
        ...
        private AClassTestable839 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable839(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable839 : AClass
    {
        public AClassTestable839(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
