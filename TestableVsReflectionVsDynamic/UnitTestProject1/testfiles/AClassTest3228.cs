...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3228
    {
        ...
        private AClassTestable3228 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3228(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3228 : AClass
    {
        public AClassTestable3228(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
