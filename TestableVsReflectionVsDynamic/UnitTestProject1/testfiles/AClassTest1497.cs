...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1497
    {
        ...
        private AClassTestable1497 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1497(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1497 : AClass
    {
        public AClassTestable1497(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
