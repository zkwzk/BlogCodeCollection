...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest828
    {
        ...
        private AClassTestable828 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable828(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable828 : AClass
    {
        public AClassTestable828(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
