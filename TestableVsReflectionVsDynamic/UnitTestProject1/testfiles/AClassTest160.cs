...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest160
    {
        ...
        private AClassTestable160 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable160(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable160 : AClass
    {
        public AClassTestable160(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
