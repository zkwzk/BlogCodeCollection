...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest993
    {
        ...
        private AClassTestable993 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable993(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable993 : AClass
    {
        public AClassTestable993(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
