...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest251
    {
        ...
        private AClassTestable251 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable251(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable251 : AClass
    {
        public AClassTestable251(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
