...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1794
    {
        ...
        private AClassTestable1794 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1794(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1794 : AClass
    {
        public AClassTestable1794(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
