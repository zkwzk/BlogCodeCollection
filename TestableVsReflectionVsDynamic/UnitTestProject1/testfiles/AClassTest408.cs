...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest408
    {
        ...
        private AClassTestable408 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable408(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable408 : AClass
    {
        public AClassTestable408(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
