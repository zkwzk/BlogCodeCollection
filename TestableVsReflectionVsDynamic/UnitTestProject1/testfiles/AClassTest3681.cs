...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3681
    {
        ...
        private AClassTestable3681 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3681(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3681 : AClass
    {
        public AClassTestable3681(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
