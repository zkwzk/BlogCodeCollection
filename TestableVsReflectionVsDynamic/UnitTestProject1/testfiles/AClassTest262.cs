...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest262
    {
        ...
        private AClassTestable262 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable262(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable262 : AClass
    {
        public AClassTestable262(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
