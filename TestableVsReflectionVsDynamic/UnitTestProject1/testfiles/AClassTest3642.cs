...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3642
    {
        ...
        private AClassTestable3642 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3642(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3642 : AClass
    {
        public AClassTestable3642(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
