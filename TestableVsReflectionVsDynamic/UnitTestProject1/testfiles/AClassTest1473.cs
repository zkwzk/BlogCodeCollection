...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1473
    {
        ...
        private AClassTestable1473 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1473(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1473 : AClass
    {
        public AClassTestable1473(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
