...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest756
    {
        ...
        private AClassTestable756 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable756(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable756 : AClass
    {
        public AClassTestable756(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
