...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3680
    {
        ...
        private AClassTestable3680 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3680(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3680 : AClass
    {
        public AClassTestable3680(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
