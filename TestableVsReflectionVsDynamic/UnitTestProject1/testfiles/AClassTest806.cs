...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest806
    {
        ...
        private AClassTestable806 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable806(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable806 : AClass
    {
        public AClassTestable806(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
