...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1337
    {
        ...
        private AClassTestable1337 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1337(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1337 : AClass
    {
        public AClassTestable1337(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
