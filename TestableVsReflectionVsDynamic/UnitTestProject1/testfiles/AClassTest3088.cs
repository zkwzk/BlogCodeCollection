...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3088
    {
        ...
        private AClassTestable3088 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3088(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3088 : AClass
    {
        public AClassTestable3088(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
