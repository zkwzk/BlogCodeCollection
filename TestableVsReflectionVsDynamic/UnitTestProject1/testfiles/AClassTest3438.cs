...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3438
    {
        ...
        private AClassTestable3438 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3438(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3438 : AClass
    {
        public AClassTestable3438(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
