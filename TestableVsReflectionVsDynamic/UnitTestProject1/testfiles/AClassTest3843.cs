...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3843
    {
        ...
        private AClassTestable3843 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3843(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3843 : AClass
    {
        public AClassTestable3843(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
