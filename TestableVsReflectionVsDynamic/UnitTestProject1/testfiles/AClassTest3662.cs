...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3662
    {
        ...
        private AClassTestable3662 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3662(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3662 : AClass
    {
        public AClassTestable3662(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
