...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest554
    {
        ...
        private AClassTestable554 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable554(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable554 : AClass
    {
        public AClassTestable554(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
