...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1291
    {
        ...
        private AClassTestable1291 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1291(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1291 : AClass
    {
        public AClassTestable1291(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
