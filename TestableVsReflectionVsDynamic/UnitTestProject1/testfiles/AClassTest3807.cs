...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3807
    {
        ...
        private AClassTestable3807 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3807(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3807 : AClass
    {
        public AClassTestable3807(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
