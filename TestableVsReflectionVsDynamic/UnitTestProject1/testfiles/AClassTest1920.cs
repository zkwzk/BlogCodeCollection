...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1920
    {
        ...
        private AClassTestable1920 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1920(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1920 : AClass
    {
        public AClassTestable1920(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
