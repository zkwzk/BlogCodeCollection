...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest316
    {
        ...
        private AClassTestable316 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable316(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable316 : AClass
    {
        public AClassTestable316(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
