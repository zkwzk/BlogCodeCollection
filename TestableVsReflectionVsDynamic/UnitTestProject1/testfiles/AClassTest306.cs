...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest306
    {
        ...
        private AClassTestable306 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable306(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable306 : AClass
    {
        public AClassTestable306(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
