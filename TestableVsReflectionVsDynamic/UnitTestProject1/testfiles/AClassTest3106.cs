...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3106
    {
        ...
        private AClassTestable3106 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3106(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3106 : AClass
    {
        public AClassTestable3106(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
