...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest487
    {
        ...
        private AClassTestable487 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable487(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable487 : AClass
    {
        public AClassTestable487(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
