...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1583
    {
        ...
        private AClassTestable1583 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1583(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1583 : AClass
    {
        public AClassTestable1583(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
