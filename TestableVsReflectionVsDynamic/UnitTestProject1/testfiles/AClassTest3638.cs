...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3638
    {
        ...
        private AClassTestable3638 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3638(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3638 : AClass
    {
        public AClassTestable3638(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
