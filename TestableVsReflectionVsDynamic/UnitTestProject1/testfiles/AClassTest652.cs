...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest652
    {
        ...
        private AClassTestable652 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable652(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable652 : AClass
    {
        public AClassTestable652(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
