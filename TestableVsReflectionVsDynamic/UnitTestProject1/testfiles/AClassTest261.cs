...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest261
    {
        ...
        private AClassTestable261 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable261(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable261 : AClass
    {
        public AClassTestable261(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
