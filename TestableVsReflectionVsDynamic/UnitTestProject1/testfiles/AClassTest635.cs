...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest635
    {
        ...
        private AClassTestable635 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable635(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable635 : AClass
    {
        public AClassTestable635(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
