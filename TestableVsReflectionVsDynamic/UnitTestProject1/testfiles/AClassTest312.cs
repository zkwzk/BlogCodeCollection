...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest312
    {
        ...
        private AClassTestable312 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable312(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable312 : AClass
    {
        public AClassTestable312(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
