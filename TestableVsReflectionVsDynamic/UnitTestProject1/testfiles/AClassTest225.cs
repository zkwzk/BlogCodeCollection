...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest225
    {
        ...
        private AClassTestable225 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable225(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable225 : AClass
    {
        public AClassTestable225(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
