...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1575
    {
        ...
        private AClassTestable1575 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1575(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1575 : AClass
    {
        public AClassTestable1575(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
