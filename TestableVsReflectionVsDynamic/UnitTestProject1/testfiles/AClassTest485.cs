...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest485
    {
        ...
        private AClassTestable485 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable485(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable485 : AClass
    {
        public AClassTestable485(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
