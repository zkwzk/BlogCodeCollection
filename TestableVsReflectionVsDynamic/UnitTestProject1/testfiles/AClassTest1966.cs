...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1966
    {
        ...
        private AClassTestable1966 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1966(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1966 : AClass
    {
        public AClassTestable1966(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
