...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1873
    {
        ...
        private AClassTestable1873 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1873(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1873 : AClass
    {
        public AClassTestable1873(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
