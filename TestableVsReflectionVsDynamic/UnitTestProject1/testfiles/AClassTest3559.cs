...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3559
    {
        ...
        private AClassTestable3559 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3559(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3559 : AClass
    {
        public AClassTestable3559(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
