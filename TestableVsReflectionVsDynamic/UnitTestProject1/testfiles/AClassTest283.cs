...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest283
    {
        ...
        private AClassTestable283 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable283(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable283 : AClass
    {
        public AClassTestable283(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
