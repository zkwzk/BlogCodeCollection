...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest605
    {
        ...
        private AClassTestable605 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable605(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable605 : AClass
    {
        public AClassTestable605(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
