...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest843
    {
        ...
        private AClassTestable843 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable843(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable843 : AClass
    {
        public AClassTestable843(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
