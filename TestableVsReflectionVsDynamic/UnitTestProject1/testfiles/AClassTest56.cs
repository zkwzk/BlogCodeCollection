...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest56
    {
        ...
        private AClassTestable56 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable56(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable56 : AClass
    {
        public AClassTestable56(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
