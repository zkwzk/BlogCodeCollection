...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest141
    {
        ...
        private AClassTestable141 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable141(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable141 : AClass
    {
        public AClassTestable141(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
