...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1896
    {
        ...
        private AClassTestable1896 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1896(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1896 : AClass
    {
        public AClassTestable1896(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
