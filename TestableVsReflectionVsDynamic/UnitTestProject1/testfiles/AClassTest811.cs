...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest811
    {
        ...
        private AClassTestable811 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable811(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable811 : AClass
    {
        public AClassTestable811(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
