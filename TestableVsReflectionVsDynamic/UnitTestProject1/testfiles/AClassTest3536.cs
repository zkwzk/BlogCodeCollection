...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3536
    {
        ...
        private AClassTestable3536 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3536(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3536 : AClass
    {
        public AClassTestable3536(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
