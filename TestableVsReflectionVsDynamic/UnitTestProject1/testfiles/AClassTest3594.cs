...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3594
    {
        ...
        private AClassTestable3594 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3594(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3594 : AClass
    {
        public AClassTestable3594(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
