...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1925
    {
        ...
        private AClassTestable1925 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1925(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1925 : AClass
    {
        public AClassTestable1925(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
