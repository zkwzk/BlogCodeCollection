...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3178
    {
        ...
        private AClassTestable3178 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3178(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3178 : AClass
    {
        public AClassTestable3178(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
