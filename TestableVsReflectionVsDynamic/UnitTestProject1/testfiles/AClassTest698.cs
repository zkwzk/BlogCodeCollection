...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest698
    {
        ...
        private AClassTestable698 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable698(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable698 : AClass
    {
        public AClassTestable698(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
