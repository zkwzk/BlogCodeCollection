...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest824
    {
        ...
        private AClassTestable824 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable824(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable824 : AClass
    {
        public AClassTestable824(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
