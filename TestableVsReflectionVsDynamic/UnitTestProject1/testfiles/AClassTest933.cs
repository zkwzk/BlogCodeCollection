...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest933
    {
        ...
        private AClassTestable933 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable933(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable933 : AClass
    {
        public AClassTestable933(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
