...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest656
    {
        ...
        private AClassTestable656 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable656(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable656 : AClass
    {
        public AClassTestable656(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
