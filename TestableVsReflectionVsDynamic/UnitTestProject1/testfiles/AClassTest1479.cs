...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1479
    {
        ...
        private AClassTestable1479 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1479(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1479 : AClass
    {
        public AClassTestable1479(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
