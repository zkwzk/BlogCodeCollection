...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3296
    {
        ...
        private AClassTestable3296 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3296(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3296 : AClass
    {
        public AClassTestable3296(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
