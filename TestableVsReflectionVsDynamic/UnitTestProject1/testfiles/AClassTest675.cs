...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest675
    {
        ...
        private AClassTestable675 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable675(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable675 : AClass
    {
        public AClassTestable675(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
