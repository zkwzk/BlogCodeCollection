...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest662
    {
        ...
        private AClassTestable662 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable662(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable662 : AClass
    {
        public AClassTestable662(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
