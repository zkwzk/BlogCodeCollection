...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3037
    {
        ...
        private AClassTestable3037 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3037(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3037 : AClass
    {
        public AClassTestable3037(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
