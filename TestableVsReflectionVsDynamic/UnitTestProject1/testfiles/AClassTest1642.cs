...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1642
    {
        ...
        private AClassTestable1642 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1642(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1642 : AClass
    {
        public AClassTestable1642(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
