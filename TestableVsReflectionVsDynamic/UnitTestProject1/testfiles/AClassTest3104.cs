...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3104
    {
        ...
        private AClassTestable3104 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3104(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3104 : AClass
    {
        public AClassTestable3104(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
