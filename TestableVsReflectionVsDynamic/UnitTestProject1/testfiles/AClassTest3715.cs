...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3715
    {
        ...
        private AClassTestable3715 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3715(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3715 : AClass
    {
        public AClassTestable3715(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
