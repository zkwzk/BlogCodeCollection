...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest20
    {
        ...
        private AClassTestable20 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable20(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable20 : AClass
    {
        public AClassTestable20(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
