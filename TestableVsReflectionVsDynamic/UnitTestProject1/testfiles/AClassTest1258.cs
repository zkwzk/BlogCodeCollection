...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1258
    {
        ...
        private AClassTestable1258 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1258(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1258 : AClass
    {
        public AClassTestable1258(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
