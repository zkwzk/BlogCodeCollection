...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1408
    {
        ...
        private AClassTestable1408 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1408(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1408 : AClass
    {
        public AClassTestable1408(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
