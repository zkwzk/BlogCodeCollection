...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3079
    {
        ...
        private AClassTestable3079 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3079(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3079 : AClass
    {
        public AClassTestable3079(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
