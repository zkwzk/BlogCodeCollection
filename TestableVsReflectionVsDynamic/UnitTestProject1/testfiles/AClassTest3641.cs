...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3641
    {
        ...
        private AClassTestable3641 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3641(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3641 : AClass
    {
        public AClassTestable3641(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
