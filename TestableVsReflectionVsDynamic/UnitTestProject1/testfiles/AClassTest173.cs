...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest173
    {
        ...
        private AClassTestable173 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable173(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable173 : AClass
    {
        public AClassTestable173(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
