...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest76
    {
        ...
        private AClassTestable76 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable76(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable76 : AClass
    {
        public AClassTestable76(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
