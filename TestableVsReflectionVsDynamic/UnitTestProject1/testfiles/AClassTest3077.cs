...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3077
    {
        ...
        private AClassTestable3077 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3077(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3077 : AClass
    {
        public AClassTestable3077(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
