...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest229
    {
        ...
        private AClassTestable229 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable229(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable229 : AClass
    {
        public AClassTestable229(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
