...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1297
    {
        ...
        private AClassTestable1297 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1297(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1297 : AClass
    {
        public AClassTestable1297(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
