...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest277
    {
        ...
        private AClassTestable277 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable277(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable277 : AClass
    {
        public AClassTestable277(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
