...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3019
    {
        ...
        private AClassTestable3019 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3019(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3019 : AClass
    {
        public AClassTestable3019(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
