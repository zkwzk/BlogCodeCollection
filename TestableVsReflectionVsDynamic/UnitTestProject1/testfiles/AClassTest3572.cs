...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3572
    {
        ...
        private AClassTestable3572 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3572(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3572 : AClass
    {
        public AClassTestable3572(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
