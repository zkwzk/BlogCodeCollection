...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest490
    {
        ...
        private AClassTestable490 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable490(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable490 : AClass
    {
        public AClassTestable490(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
