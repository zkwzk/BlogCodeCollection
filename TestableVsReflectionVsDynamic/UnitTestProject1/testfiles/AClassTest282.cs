...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest282
    {
        ...
        private AClassTestable282 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable282(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable282 : AClass
    {
        public AClassTestable282(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
