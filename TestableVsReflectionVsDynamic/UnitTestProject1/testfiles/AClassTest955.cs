...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest955
    {
        ...
        private AClassTestable955 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable955(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable955 : AClass
    {
        public AClassTestable955(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
