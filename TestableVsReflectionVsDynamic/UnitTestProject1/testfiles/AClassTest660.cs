...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest660
    {
        ...
        private AClassTestable660 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable660(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable660 : AClass
    {
        public AClassTestable660(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
