...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest709
    {
        ...
        private AClassTestable709 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable709(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable709 : AClass
    {
        public AClassTestable709(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
