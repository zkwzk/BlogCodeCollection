...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest916
    {
        ...
        private AClassTestable916 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable916(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable916 : AClass
    {
        public AClassTestable916(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
