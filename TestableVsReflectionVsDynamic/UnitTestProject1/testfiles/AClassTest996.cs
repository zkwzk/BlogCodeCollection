...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest996
    {
        ...
        private AClassTestable996 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable996(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable996 : AClass
    {
        public AClassTestable996(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
