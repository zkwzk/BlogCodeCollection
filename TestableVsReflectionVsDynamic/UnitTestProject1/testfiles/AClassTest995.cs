...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest995
    {
        ...
        private AClassTestable995 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable995(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable995 : AClass
    {
        public AClassTestable995(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
