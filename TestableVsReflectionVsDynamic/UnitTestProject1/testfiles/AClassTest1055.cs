...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1055
    {
        ...
        private AClassTestable1055 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1055(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1055 : AClass
    {
        public AClassTestable1055(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
