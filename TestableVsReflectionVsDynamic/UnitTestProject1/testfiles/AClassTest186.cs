...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest186
    {
        ...
        private AClassTestable186 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable186(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable186 : AClass
    {
        public AClassTestable186(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
