...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1852
    {
        ...
        private AClassTestable1852 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1852(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1852 : AClass
    {
        public AClassTestable1852(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
