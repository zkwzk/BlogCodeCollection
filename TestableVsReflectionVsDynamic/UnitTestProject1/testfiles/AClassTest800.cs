...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest800
    {
        ...
        private AClassTestable800 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable800(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable800 : AClass
    {
        public AClassTestable800(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
