...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest430
    {
        ...
        private AClassTestable430 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable430(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable430 : AClass
    {
        public AClassTestable430(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
