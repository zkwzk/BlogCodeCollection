...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest568
    {
        ...
        private AClassTestable568 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable568(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable568 : AClass
    {
        public AClassTestable568(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
