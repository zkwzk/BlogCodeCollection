...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest693
    {
        ...
        private AClassTestable693 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable693(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable693 : AClass
    {
        public AClassTestable693(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
