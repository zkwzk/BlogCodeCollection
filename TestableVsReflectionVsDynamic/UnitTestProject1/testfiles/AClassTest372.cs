...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest372
    {
        ...
        private AClassTestable372 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable372(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable372 : AClass
    {
        public AClassTestable372(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
