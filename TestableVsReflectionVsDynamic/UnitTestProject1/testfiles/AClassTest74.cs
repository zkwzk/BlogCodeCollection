...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest74
    {
        ...
        private AClassTestable74 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable74(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable74 : AClass
    {
        public AClassTestable74(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
