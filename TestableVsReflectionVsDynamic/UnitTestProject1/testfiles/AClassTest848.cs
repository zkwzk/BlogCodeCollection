...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest848
    {
        ...
        private AClassTestable848 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable848(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable848 : AClass
    {
        public AClassTestable848(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
