...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3940
    {
        ...
        private AClassTestable3940 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3940(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3940 : AClass
    {
        public AClassTestable3940(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
