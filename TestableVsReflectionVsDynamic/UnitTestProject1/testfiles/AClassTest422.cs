...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest422
    {
        ...
        private AClassTestable422 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable422(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable422 : AClass
    {
        public AClassTestable422(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
