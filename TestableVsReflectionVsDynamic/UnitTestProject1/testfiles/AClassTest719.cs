...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest719
    {
        ...
        private AClassTestable719 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable719(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable719 : AClass
    {
        public AClassTestable719(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
