...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest619
    {
        ...
        private AClassTestable619 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable619(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable619 : AClass
    {
        public AClassTestable619(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
