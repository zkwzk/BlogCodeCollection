...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest584
    {
        ...
        private AClassTestable584 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable584(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable584 : AClass
    {
        public AClassTestable584(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
