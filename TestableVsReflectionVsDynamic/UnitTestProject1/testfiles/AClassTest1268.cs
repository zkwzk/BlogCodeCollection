...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1268
    {
        ...
        private AClassTestable1268 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1268(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1268 : AClass
    {
        public AClassTestable1268(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
