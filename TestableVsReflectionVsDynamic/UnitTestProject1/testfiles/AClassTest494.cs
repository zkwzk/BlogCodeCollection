...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest494
    {
        ...
        private AClassTestable494 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable494(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable494 : AClass
    {
        public AClassTestable494(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
