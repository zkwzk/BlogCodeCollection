...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1467
    {
        ...
        private AClassTestable1467 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1467(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1467 : AClass
    {
        public AClassTestable1467(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
