...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest224
    {
        ...
        private AClassTestable224 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable224(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable224 : AClass
    {
        public AClassTestable224(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
