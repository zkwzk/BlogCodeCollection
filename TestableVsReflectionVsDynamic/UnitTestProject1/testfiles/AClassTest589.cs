...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest589
    {
        ...
        private AClassTestable589 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable589(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable589 : AClass
    {
        public AClassTestable589(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
