...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3651
    {
        ...
        private AClassTestable3651 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3651(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3651 : AClass
    {
        public AClassTestable3651(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
