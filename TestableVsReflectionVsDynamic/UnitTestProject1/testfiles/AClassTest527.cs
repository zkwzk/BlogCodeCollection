...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest527
    {
        ...
        private AClassTestable527 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable527(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable527 : AClass
    {
        public AClassTestable527(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
