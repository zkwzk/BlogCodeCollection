...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest836
    {
        ...
        private AClassTestable836 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable836(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable836 : AClass
    {
        public AClassTestable836(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
