...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1277
    {
        ...
        private AClassTestable1277 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1277(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1277 : AClass
    {
        public AClassTestable1277(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
