...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest814
    {
        ...
        private AClassTestable814 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable814(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable814 : AClass
    {
        public AClassTestable814(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
