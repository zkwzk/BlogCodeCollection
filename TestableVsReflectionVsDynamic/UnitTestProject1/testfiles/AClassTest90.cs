...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest90
    {
        ...
        private AClassTestable90 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable90(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable90 : AClass
    {
        public AClassTestable90(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
