...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest857
    {
        ...
        private AClassTestable857 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable857(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable857 : AClass
    {
        public AClassTestable857(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
