...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest931
    {
        ...
        private AClassTestable931 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable931(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable931 : AClass
    {
        public AClassTestable931(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
