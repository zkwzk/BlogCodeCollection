...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3721
    {
        ...
        private AClassTestable3721 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3721(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3721 : AClass
    {
        public AClassTestable3721(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
