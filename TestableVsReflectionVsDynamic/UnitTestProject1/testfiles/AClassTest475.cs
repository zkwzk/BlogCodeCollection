...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest475
    {
        ...
        private AClassTestable475 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable475(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable475 : AClass
    {
        public AClassTestable475(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
