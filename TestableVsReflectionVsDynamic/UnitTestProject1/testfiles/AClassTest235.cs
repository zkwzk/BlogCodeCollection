...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest235
    {
        ...
        private AClassTestable235 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable235(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable235 : AClass
    {
        public AClassTestable235(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
