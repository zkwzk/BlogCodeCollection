...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3034
    {
        ...
        private AClassTestable3034 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3034(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3034 : AClass
    {
        public AClassTestable3034(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
