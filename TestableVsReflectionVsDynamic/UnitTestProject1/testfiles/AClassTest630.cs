...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest630
    {
        ...
        private AClassTestable630 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable630(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable630 : AClass
    {
        public AClassTestable630(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
