...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest454
    {
        ...
        private AClassTestable454 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable454(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable454 : AClass
    {
        public AClassTestable454(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
