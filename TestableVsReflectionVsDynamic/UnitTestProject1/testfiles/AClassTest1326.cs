...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1326
    {
        ...
        private AClassTestable1326 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1326(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1326 : AClass
    {
        public AClassTestable1326(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
