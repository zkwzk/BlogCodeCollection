...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest471
    {
        ...
        private AClassTestable471 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable471(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable471 : AClass
    {
        public AClassTestable471(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
