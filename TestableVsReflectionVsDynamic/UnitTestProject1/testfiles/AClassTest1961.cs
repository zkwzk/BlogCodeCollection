...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1961
    {
        ...
        private AClassTestable1961 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1961(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1961 : AClass
    {
        public AClassTestable1961(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
