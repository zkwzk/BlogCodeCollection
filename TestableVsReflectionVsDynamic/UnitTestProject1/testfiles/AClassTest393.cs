...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest393
    {
        ...
        private AClassTestable393 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable393(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable393 : AClass
    {
        public AClassTestable393(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
