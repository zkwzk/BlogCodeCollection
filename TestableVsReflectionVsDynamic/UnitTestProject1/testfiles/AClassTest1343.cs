...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1343
    {
        ...
        private AClassTestable1343 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1343(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1343 : AClass
    {
        public AClassTestable1343(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
