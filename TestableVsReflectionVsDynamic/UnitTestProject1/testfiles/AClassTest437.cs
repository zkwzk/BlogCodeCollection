...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest437
    {
        ...
        private AClassTestable437 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable437(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable437 : AClass
    {
        public AClassTestable437(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
