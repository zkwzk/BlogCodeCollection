...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3306
    {
        ...
        private AClassTestable3306 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3306(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3306 : AClass
    {
        public AClassTestable3306(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
