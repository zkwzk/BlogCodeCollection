...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest128
    {
        ...
        private AClassTestable128 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable128(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable128 : AClass
    {
        public AClassTestable128(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
