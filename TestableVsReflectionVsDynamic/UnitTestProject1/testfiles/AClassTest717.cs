...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest717
    {
        ...
        private AClassTestable717 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable717(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable717 : AClass
    {
        public AClassTestable717(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
