...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest985
    {
        ...
        private AClassTestable985 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable985(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable985 : AClass
    {
        public AClassTestable985(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
