...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest991
    {
        ...
        private AClassTestable991 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable991(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable991 : AClass
    {
        public AClassTestable991(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
