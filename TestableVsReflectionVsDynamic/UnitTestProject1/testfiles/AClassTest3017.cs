...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3017
    {
        ...
        private AClassTestable3017 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3017(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3017 : AClass
    {
        public AClassTestable3017(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
