...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1874
    {
        ...
        private AClassTestable1874 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1874(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1874 : AClass
    {
        public AClassTestable1874(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
