...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest172
    {
        ...
        private AClassTestable172 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable172(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable172 : AClass
    {
        public AClassTestable172(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
