...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest908
    {
        ...
        private AClassTestable908 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable908(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable908 : AClass
    {
        public AClassTestable908(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
