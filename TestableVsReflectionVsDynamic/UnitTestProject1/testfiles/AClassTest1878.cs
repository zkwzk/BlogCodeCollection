...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1878
    {
        ...
        private AClassTestable1878 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1878(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1878 : AClass
    {
        public AClassTestable1878(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
