...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1850
    {
        ...
        private AClassTestable1850 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1850(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1850 : AClass
    {
        public AClassTestable1850(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
