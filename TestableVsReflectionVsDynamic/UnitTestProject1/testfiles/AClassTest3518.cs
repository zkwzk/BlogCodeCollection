...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3518
    {
        ...
        private AClassTestable3518 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3518(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3518 : AClass
    {
        public AClassTestable3518(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
