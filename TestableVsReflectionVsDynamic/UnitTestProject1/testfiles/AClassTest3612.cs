...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3612
    {
        ...
        private AClassTestable3612 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3612(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3612 : AClass
    {
        public AClassTestable3612(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
