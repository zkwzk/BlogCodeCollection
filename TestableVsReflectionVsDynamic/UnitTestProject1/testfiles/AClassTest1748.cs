...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1748
    {
        ...
        private AClassTestable1748 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1748(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1748 : AClass
    {
        public AClassTestable1748(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
