...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest796
    {
        ...
        private AClassTestable796 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable796(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable796 : AClass
    {
        public AClassTestable796(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
