...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest65
    {
        ...
        private AClassTestable65 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable65(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable65 : AClass
    {
        public AClassTestable65(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
