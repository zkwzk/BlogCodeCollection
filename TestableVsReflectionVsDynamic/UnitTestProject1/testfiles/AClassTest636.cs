...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest636
    {
        ...
        private AClassTestable636 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable636(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable636 : AClass
    {
        public AClassTestable636(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
