...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1450
    {
        ...
        private AClassTestable1450 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1450(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1450 : AClass
    {
        public AClassTestable1450(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
