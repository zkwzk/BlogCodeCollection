...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3852
    {
        ...
        private AClassTestable3852 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3852(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3852 : AClass
    {
        public AClassTestable3852(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
