...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest409
    {
        ...
        private AClassTestable409 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable409(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable409 : AClass
    {
        public AClassTestable409(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
