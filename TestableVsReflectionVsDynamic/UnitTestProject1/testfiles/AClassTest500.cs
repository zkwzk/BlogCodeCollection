...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest500
    {
        ...
        private AClassTestable500 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable500(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable500 : AClass
    {
        public AClassTestable500(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
