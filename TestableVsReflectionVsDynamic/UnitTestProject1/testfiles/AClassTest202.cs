...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest202
    {
        ...
        private AClassTestable202 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable202(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable202 : AClass
    {
        public AClassTestable202(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
