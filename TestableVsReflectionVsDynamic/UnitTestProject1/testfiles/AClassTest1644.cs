...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1644
    {
        ...
        private AClassTestable1644 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1644(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1644 : AClass
    {
        public AClassTestable1644(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
