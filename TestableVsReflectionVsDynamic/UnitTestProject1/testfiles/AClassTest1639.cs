...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1639
    {
        ...
        private AClassTestable1639 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1639(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1639 : AClass
    {
        public AClassTestable1639(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
