...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1727
    {
        ...
        private AClassTestable1727 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1727(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1727 : AClass
    {
        public AClassTestable1727(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
