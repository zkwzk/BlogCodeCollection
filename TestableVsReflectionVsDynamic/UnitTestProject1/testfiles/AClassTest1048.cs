...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1048
    {
        ...
        private AClassTestable1048 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1048(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1048 : AClass
    {
        public AClassTestable1048(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
