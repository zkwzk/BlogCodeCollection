...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3045
    {
        ...
        private AClassTestable3045 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3045(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3045 : AClass
    {
        public AClassTestable3045(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
