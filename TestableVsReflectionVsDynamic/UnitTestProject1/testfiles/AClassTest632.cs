...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest632
    {
        ...
        private AClassTestable632 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable632(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable632 : AClass
    {
        public AClassTestable632(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
