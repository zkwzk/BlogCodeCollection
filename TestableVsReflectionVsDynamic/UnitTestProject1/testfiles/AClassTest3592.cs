...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3592
    {
        ...
        private AClassTestable3592 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3592(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3592 : AClass
    {
        public AClassTestable3592(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
