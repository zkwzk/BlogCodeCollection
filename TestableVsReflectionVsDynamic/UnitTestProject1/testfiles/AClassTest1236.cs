...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1236
    {
        ...
        private AClassTestable1236 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1236(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1236 : AClass
    {
        public AClassTestable1236(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
