...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest93
    {
        ...
        private AClassTestable93 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable93(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable93 : AClass
    {
        public AClassTestable93(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
