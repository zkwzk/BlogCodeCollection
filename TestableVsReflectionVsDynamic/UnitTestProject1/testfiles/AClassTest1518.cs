...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1518
    {
        ...
        private AClassTestable1518 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1518(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1518 : AClass
    {
        public AClassTestable1518(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
