...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest928
    {
        ...
        private AClassTestable928 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable928(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable928 : AClass
    {
        public AClassTestable928(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
