...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest87
    {
        ...
        private AClassTestable87 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable87(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable87 : AClass
    {
        public AClassTestable87(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
