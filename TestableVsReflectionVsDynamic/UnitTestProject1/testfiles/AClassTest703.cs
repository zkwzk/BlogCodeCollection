...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest703
    {
        ...
        private AClassTestable703 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable703(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable703 : AClass
    {
        public AClassTestable703(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
