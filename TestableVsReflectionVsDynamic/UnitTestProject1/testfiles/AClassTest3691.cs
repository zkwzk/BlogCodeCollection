...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3691
    {
        ...
        private AClassTestable3691 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3691(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3691 : AClass
    {
        public AClassTestable3691(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
