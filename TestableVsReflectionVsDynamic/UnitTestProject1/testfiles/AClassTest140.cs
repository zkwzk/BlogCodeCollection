...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest140
    {
        ...
        private AClassTestable140 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable140(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable140 : AClass
    {
        public AClassTestable140(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
