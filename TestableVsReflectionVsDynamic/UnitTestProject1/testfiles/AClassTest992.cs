...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest992
    {
        ...
        private AClassTestable992 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable992(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable992 : AClass
    {
        public AClassTestable992(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
