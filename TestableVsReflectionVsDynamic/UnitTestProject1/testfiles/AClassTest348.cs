...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest348
    {
        ...
        private AClassTestable348 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable348(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable348 : AClass
    {
        public AClassTestable348(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
