...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest947
    {
        ...
        private AClassTestable947 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable947(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable947 : AClass
    {
        public AClassTestable947(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
