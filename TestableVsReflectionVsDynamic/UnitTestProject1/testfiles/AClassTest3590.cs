...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3590
    {
        ...
        private AClassTestable3590 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3590(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3590 : AClass
    {
        public AClassTestable3590(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
