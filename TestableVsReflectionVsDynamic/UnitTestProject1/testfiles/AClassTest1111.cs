...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1111
    {
        ...
        private AClassTestable1111 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1111(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1111 : AClass
    {
        public AClassTestable1111(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
