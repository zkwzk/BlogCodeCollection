...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3750
    {
        ...
        private AClassTestable3750 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3750(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3750 : AClass
    {
        public AClassTestable3750(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
