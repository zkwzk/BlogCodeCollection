...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest190
    {
        ...
        private AClassTestable190 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable190(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable190 : AClass
    {
        public AClassTestable190(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
