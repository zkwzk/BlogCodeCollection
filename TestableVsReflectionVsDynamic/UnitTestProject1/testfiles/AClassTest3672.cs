...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3672
    {
        ...
        private AClassTestable3672 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3672(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3672 : AClass
    {
        public AClassTestable3672(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
