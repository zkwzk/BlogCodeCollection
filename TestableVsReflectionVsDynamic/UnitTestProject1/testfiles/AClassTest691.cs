...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest691
    {
        ...
        private AClassTestable691 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable691(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable691 : AClass
    {
        public AClassTestable691(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
