...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest157
    {
        ...
        private AClassTestable157 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable157(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable157 : AClass
    {
        public AClassTestable157(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
