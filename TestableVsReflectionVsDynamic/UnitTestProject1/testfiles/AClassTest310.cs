...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest310
    {
        ...
        private AClassTestable310 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable310(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable310 : AClass
    {
        public AClassTestable310(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
