...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest220
    {
        ...
        private AClassTestable220 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable220(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable220 : AClass
    {
        public AClassTestable220(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
