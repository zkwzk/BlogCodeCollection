...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1762
    {
        ...
        private AClassTestable1762 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1762(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1762 : AClass
    {
        public AClassTestable1762(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
