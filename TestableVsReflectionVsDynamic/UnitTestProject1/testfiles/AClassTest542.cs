...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest542
    {
        ...
        private AClassTestable542 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable542(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable542 : AClass
    {
        public AClassTestable542(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
