...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest952
    {
        ...
        private AClassTestable952 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable952(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable952 : AClass
    {
        public AClassTestable952(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
