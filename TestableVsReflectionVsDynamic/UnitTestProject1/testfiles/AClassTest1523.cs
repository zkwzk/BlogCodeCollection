...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1523
    {
        ...
        private AClassTestable1523 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1523(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1523 : AClass
    {
        public AClassTestable1523(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
