...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest205
    {
        ...
        private AClassTestable205 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable205(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable205 : AClass
    {
        public AClassTestable205(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
