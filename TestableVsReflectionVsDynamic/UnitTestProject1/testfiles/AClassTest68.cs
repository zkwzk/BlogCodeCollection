...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest68
    {
        ...
        private AClassTestable68 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable68(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable68 : AClass
    {
        public AClassTestable68(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
