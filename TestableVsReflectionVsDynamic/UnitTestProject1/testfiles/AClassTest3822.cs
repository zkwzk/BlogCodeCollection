...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3822
    {
        ...
        private AClassTestable3822 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3822(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3822 : AClass
    {
        public AClassTestable3822(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
