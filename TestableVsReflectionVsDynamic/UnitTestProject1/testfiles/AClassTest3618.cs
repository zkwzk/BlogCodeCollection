...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3618
    {
        ...
        private AClassTestable3618 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3618(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3618 : AClass
    {
        public AClassTestable3618(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
