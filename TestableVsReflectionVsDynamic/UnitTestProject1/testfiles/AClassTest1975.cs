...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1975
    {
        ...
        private AClassTestable1975 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1975(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1975 : AClass
    {
        public AClassTestable1975(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
