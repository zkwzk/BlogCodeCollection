...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest949
    {
        ...
        private AClassTestable949 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable949(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable949 : AClass
    {
        public AClassTestable949(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
