...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3913
    {
        ...
        private AClassTestable3913 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3913(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3913 : AClass
    {
        public AClassTestable3913(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
