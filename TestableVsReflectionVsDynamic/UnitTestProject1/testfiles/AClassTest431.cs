...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest431
    {
        ...
        private AClassTestable431 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable431(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable431 : AClass
    {
        public AClassTestable431(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
