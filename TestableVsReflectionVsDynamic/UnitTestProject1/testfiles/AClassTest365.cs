...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest365
    {
        ...
        private AClassTestable365 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable365(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable365 : AClass
    {
        public AClassTestable365(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
