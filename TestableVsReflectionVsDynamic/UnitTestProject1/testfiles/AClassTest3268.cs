...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3268
    {
        ...
        private AClassTestable3268 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3268(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3268 : AClass
    {
        public AClassTestable3268(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
