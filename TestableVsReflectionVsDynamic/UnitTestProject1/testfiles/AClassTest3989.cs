...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3989
    {
        ...
        private AClassTestable3989 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3989(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3989 : AClass
    {
        public AClassTestable3989(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
