...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1378
    {
        ...
        private AClassTestable1378 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1378(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1378 : AClass
    {
        public AClassTestable1378(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
