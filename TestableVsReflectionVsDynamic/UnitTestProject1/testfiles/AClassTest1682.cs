...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1682
    {
        ...
        private AClassTestable1682 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1682(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1682 : AClass
    {
        public AClassTestable1682(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
