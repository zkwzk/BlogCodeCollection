...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3870
    {
        ...
        private AClassTestable3870 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3870(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3870 : AClass
    {
        public AClassTestable3870(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
