...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest732
    {
        ...
        private AClassTestable732 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable732(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable732 : AClass
    {
        public AClassTestable732(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
