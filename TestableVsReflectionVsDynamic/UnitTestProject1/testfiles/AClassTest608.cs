...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest608
    {
        ...
        private AClassTestable608 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable608(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable608 : AClass
    {
        public AClassTestable608(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
