...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3943
    {
        ...
        private AClassTestable3943 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3943(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3943 : AClass
    {
        public AClassTestable3943(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
