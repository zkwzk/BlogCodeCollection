...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest507
    {
        ...
        private AClassTestable507 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable507(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable507 : AClass
    {
        public AClassTestable507(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
