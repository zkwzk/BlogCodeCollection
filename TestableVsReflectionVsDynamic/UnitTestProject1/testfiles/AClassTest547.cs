...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest547
    {
        ...
        private AClassTestable547 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable547(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable547 : AClass
    {
        public AClassTestable547(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
