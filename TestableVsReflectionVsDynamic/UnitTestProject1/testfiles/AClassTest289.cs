...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest289
    {
        ...
        private AClassTestable289 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable289(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable289 : AClass
    {
        public AClassTestable289(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
