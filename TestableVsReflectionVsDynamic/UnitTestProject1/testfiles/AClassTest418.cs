...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest418
    {
        ...
        private AClassTestable418 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable418(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable418 : AClass
    {
        public AClassTestable418(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
