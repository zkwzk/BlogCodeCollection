...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3864
    {
        ...
        private AClassTestable3864 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3864(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3864 : AClass
    {
        public AClassTestable3864(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
