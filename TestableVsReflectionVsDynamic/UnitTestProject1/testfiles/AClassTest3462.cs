...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3462
    {
        ...
        private AClassTestable3462 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3462(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3462 : AClass
    {
        public AClassTestable3462(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
