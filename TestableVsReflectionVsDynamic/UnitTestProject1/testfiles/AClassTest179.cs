...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest179
    {
        ...
        private AClassTestable179 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable179(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable179 : AClass
    {
        public AClassTestable179(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
