...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest279
    {
        ...
        private AClassTestable279 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable279(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable279 : AClass
    {
        public AClassTestable279(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
