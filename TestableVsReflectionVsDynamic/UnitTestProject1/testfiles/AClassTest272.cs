...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest272
    {
        ...
        private AClassTestable272 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable272(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable272 : AClass
    {
        public AClassTestable272(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
