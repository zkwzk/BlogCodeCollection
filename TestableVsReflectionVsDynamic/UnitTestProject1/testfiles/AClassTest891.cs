...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest891
    {
        ...
        private AClassTestable891 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable891(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable891 : AClass
    {
        public AClassTestable891(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
