...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest154
    {
        ...
        private AClassTestable154 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable154(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable154 : AClass
    {
        public AClassTestable154(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
