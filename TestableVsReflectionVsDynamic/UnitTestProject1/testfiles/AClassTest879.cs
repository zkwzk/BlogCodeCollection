...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest879
    {
        ...
        private AClassTestable879 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable879(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable879 : AClass
    {
        public AClassTestable879(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
