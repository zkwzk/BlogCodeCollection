...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3775
    {
        ...
        private AClassTestable3775 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3775(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3775 : AClass
    {
        public AClassTestable3775(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
