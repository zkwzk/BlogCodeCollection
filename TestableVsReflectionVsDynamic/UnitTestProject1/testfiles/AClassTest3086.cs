...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3086
    {
        ...
        private AClassTestable3086 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3086(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3086 : AClass
    {
        public AClassTestable3086(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
