...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest264
    {
        ...
        private AClassTestable264 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable264(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable264 : AClass
    {
        public AClassTestable264(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
