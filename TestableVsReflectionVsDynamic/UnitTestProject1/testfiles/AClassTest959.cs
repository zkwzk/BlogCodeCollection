...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest959
    {
        ...
        private AClassTestable959 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable959(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable959 : AClass
    {
        public AClassTestable959(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
