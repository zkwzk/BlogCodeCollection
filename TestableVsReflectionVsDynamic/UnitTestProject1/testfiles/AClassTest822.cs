...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest822
    {
        ...
        private AClassTestable822 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable822(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable822 : AClass
    {
        public AClassTestable822(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
