...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest55
    {
        ...
        private AClassTestable55 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable55(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable55 : AClass
    {
        public AClassTestable55(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
