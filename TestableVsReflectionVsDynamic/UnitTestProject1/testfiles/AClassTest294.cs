...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest294
    {
        ...
        private AClassTestable294 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable294(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable294 : AClass
    {
        public AClassTestable294(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
