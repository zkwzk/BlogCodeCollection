...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest501
    {
        ...
        private AClassTestable501 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable501(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable501 : AClass
    {
        public AClassTestable501(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
