...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3654
    {
        ...
        private AClassTestable3654 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3654(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3654 : AClass
    {
        public AClassTestable3654(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
