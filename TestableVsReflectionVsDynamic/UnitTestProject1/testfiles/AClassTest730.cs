...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest730
    {
        ...
        private AClassTestable730 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable730(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable730 : AClass
    {
        public AClassTestable730(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
