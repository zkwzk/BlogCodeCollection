...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3003
    {
        ...
        private AClassTestable3003 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3003(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3003 : AClass
    {
        public AClassTestable3003(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
