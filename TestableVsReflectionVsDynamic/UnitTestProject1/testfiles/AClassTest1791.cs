...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1791
    {
        ...
        private AClassTestable1791 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1791(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1791 : AClass
    {
        public AClassTestable1791(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
