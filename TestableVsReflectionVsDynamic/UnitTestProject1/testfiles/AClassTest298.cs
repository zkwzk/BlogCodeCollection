...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest298
    {
        ...
        private AClassTestable298 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable298(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable298 : AClass
    {
        public AClassTestable298(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
