...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest451
    {
        ...
        private AClassTestable451 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable451(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable451 : AClass
    {
        public AClassTestable451(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
