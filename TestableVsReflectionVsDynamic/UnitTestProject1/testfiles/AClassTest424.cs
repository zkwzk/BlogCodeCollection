...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest424
    {
        ...
        private AClassTestable424 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable424(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable424 : AClass
    {
        public AClassTestable424(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
