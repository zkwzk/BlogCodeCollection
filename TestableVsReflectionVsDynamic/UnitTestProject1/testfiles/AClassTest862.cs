...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest862
    {
        ...
        private AClassTestable862 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable862(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable862 : AClass
    {
        public AClassTestable862(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
