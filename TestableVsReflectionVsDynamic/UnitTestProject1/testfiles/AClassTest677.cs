...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest677
    {
        ...
        private AClassTestable677 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable677(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable677 : AClass
    {
        public AClassTestable677(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
