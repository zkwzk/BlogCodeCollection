...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest194
    {
        ...
        private AClassTestable194 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable194(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable194 : AClass
    {
        public AClassTestable194(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
