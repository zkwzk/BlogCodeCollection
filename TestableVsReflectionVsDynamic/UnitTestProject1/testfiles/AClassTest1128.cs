...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1128
    {
        ...
        private AClassTestable1128 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1128(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1128 : AClass
    {
        public AClassTestable1128(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
