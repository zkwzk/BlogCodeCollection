...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest21
    {
        ...
        private AClassTestable21 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable21(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable21 : AClass
    {
        public AClassTestable21(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
