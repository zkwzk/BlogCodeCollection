...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1056
    {
        ...
        private AClassTestable1056 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1056(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1056 : AClass
    {
        public AClassTestable1056(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
