...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest776
    {
        ...
        private AClassTestable776 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable776(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable776 : AClass
    {
        public AClassTestable776(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
