...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest314
    {
        ...
        private AClassTestable314 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable314(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable314 : AClass
    {
        public AClassTestable314(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
