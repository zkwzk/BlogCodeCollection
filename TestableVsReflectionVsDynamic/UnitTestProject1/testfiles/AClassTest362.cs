...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest362
    {
        ...
        private AClassTestable362 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable362(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable362 : AClass
    {
        public AClassTestable362(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
