...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest964
    {
        ...
        private AClassTestable964 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable964(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable964 : AClass
    {
        public AClassTestable964(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
