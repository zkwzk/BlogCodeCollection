...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest785
    {
        ...
        private AClassTestable785 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable785(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable785 : AClass
    {
        public AClassTestable785(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
