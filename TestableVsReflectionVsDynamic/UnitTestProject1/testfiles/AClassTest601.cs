...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest601
    {
        ...
        private AClassTestable601 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable601(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable601 : AClass
    {
        public AClassTestable601(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
