...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3147
    {
        ...
        private AClassTestable3147 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3147(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3147 : AClass
    {
        public AClassTestable3147(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
