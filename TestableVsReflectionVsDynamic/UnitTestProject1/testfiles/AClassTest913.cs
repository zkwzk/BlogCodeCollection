...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest913
    {
        ...
        private AClassTestable913 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable913(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable913 : AClass
    {
        public AClassTestable913(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
