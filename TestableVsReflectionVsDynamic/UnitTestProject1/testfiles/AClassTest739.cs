...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest739
    {
        ...
        private AClassTestable739 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable739(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable739 : AClass
    {
        public AClassTestable739(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
