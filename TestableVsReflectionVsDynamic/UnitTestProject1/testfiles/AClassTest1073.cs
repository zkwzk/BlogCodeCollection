...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1073
    {
        ...
        private AClassTestable1073 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1073(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1073 : AClass
    {
        public AClassTestable1073(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
