...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest576
    {
        ...
        private AClassTestable576 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable576(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable576 : AClass
    {
        public AClassTestable576(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
