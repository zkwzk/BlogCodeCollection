...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1640
    {
        ...
        private AClassTestable1640 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1640(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1640 : AClass
    {
        public AClassTestable1640(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
