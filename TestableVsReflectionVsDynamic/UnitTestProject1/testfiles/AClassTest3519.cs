...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3519
    {
        ...
        private AClassTestable3519 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3519(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3519 : AClass
    {
        public AClassTestable3519(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
