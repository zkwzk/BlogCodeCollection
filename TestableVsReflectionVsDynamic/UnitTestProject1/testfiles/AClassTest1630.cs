...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1630
    {
        ...
        private AClassTestable1630 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1630(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1630 : AClass
    {
        public AClassTestable1630(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
