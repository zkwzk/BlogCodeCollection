...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest531
    {
        ...
        private AClassTestable531 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable531(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable531 : AClass
    {
        public AClassTestable531(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
