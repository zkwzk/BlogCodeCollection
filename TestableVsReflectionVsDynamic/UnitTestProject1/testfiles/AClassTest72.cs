...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest72
    {
        ...
        private AClassTestable72 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable72(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable72 : AClass
    {
        public AClassTestable72(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
