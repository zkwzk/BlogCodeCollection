...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3509
    {
        ...
        private AClassTestable3509 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3509(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3509 : AClass
    {
        public AClassTestable3509(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
