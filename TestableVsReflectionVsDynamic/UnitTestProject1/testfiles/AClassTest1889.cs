...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1889
    {
        ...
        private AClassTestable1889 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1889(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1889 : AClass
    {
        public AClassTestable1889(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
