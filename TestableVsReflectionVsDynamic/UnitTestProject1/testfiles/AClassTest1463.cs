...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1463
    {
        ...
        private AClassTestable1463 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1463(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1463 : AClass
    {
        public AClassTestable1463(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
