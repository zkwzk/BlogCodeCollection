...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3876
    {
        ...
        private AClassTestable3876 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3876(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3876 : AClass
    {
        public AClassTestable3876(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
