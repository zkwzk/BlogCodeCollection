...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3027
    {
        ...
        private AClassTestable3027 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3027(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3027 : AClass
    {
        public AClassTestable3027(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
