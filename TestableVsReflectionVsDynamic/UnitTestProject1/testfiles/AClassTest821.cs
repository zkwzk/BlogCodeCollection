...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest821
    {
        ...
        private AClassTestable821 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable821(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable821 : AClass
    {
        public AClassTestable821(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
