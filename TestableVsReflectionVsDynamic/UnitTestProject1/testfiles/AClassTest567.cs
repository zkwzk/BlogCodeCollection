...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest567
    {
        ...
        private AClassTestable567 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable567(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable567 : AClass
    {
        public AClassTestable567(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
