...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest545
    {
        ...
        private AClassTestable545 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable545(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable545 : AClass
    {
        public AClassTestable545(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
