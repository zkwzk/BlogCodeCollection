...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3186
    {
        ...
        private AClassTestable3186 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3186(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3186 : AClass
    {
        public AClassTestable3186(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
