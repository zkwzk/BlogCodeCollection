...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1638
    {
        ...
        private AClassTestable1638 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1638(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1638 : AClass
    {
        public AClassTestable1638(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
