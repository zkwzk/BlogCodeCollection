...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest107
    {
        ...
        private AClassTestable107 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable107(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable107 : AClass
    {
        public AClassTestable107(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
