...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3962
    {
        ...
        private AClassTestable3962 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3962(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3962 : AClass
    {
        public AClassTestable3962(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
