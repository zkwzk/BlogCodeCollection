...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest290
    {
        ...
        private AClassTestable290 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable290(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable290 : AClass
    {
        public AClassTestable290(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
