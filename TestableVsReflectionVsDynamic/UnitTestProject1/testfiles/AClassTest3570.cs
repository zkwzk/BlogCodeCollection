...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3570
    {
        ...
        private AClassTestable3570 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3570(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3570 : AClass
    {
        public AClassTestable3570(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
