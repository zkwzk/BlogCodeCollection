...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest449
    {
        ...
        private AClassTestable449 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable449(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable449 : AClass
    {
        public AClassTestable449(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
