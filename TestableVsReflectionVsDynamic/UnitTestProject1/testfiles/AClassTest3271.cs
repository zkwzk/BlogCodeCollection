...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3271
    {
        ...
        private AClassTestable3271 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3271(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3271 : AClass
    {
        public AClassTestable3271(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
