...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest694
    {
        ...
        private AClassTestable694 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable694(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable694 : AClass
    {
        public AClassTestable694(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
