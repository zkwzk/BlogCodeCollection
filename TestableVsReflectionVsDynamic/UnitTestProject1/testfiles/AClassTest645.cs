...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest645
    {
        ...
        private AClassTestable645 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable645(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable645 : AClass
    {
        public AClassTestable645(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
