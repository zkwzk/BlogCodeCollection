...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest402
    {
        ...
        private AClassTestable402 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable402(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable402 : AClass
    {
        public AClassTestable402(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
