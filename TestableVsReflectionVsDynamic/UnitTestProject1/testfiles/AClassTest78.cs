...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest78
    {
        ...
        private AClassTestable78 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable78(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable78 : AClass
    {
        public AClassTestable78(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
