...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest293
    {
        ...
        private AClassTestable293 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable293(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable293 : AClass
    {
        public AClassTestable293(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
