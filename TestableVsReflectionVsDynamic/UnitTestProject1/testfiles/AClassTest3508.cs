...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3508
    {
        ...
        private AClassTestable3508 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3508(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3508 : AClass
    {
        public AClassTestable3508(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
