...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest727
    {
        ...
        private AClassTestable727 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable727(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable727 : AClass
    {
        public AClassTestable727(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
