...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest616
    {
        ...
        private AClassTestable616 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable616(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable616 : AClass
    {
        public AClassTestable616(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
