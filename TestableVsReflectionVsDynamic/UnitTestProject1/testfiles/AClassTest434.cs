...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest434
    {
        ...
        private AClassTestable434 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable434(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable434 : AClass
    {
        public AClassTestable434(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
