...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest412
    {
        ...
        private AClassTestable412 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable412(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable412 : AClass
    {
        public AClassTestable412(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
