...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3994
    {
        ...
        private AClassTestable3994 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3994(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3994 : AClass
    {
        public AClassTestable3994(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
