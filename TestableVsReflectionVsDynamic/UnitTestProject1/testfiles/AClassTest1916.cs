...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1916
    {
        ...
        private AClassTestable1916 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1916(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1916 : AClass
    {
        public AClassTestable1916(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
