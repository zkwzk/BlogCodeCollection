...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1469
    {
        ...
        private AClassTestable1469 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1469(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1469 : AClass
    {
        public AClassTestable1469(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
