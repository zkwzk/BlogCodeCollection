...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest325
    {
        ...
        private AClassTestable325 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable325(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable325 : AClass
    {
        public AClassTestable325(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
