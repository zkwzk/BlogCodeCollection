...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest805
    {
        ...
        private AClassTestable805 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable805(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable805 : AClass
    {
        public AClassTestable805(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
