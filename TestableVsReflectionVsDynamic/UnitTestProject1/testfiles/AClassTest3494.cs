...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3494
    {
        ...
        private AClassTestable3494 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3494(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3494 : AClass
    {
        public AClassTestable3494(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
