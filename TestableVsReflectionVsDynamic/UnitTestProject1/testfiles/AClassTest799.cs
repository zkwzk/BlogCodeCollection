...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest799
    {
        ...
        private AClassTestable799 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable799(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable799 : AClass
    {
        public AClassTestable799(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
