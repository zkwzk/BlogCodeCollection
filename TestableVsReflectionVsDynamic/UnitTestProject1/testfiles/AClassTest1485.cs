...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1485
    {
        ...
        private AClassTestable1485 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1485(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1485 : AClass
    {
        public AClassTestable1485(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
