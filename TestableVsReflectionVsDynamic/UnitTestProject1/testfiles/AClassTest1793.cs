...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1793
    {
        ...
        private AClassTestable1793 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1793(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1793 : AClass
    {
        public AClassTestable1793(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
