...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1623
    {
        ...
        private AClassTestable1623 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1623(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1623 : AClass
    {
        public AClassTestable1623(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
