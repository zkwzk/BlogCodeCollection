...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3644
    {
        ...
        private AClassTestable3644 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3644(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3644 : AClass
    {
        public AClassTestable3644(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
