...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest129
    {
        ...
        private AClassTestable129 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable129(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable129 : AClass
    {
        public AClassTestable129(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
