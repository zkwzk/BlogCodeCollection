...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3628
    {
        ...
        private AClassTestable3628 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3628(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3628 : AClass
    {
        public AClassTestable3628(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
