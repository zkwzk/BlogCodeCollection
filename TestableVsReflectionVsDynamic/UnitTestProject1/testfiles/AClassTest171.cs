...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest171
    {
        ...
        private AClassTestable171 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable171(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable171 : AClass
    {
        public AClassTestable171(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
