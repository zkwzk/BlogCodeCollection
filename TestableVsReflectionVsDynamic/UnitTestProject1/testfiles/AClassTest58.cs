...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest58
    {
        ...
        private AClassTestable58 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable58(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable58 : AClass
    {
        public AClassTestable58(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
