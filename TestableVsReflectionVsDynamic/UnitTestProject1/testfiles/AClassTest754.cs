...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest754
    {
        ...
        private AClassTestable754 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable754(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable754 : AClass
    {
        public AClassTestable754(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
