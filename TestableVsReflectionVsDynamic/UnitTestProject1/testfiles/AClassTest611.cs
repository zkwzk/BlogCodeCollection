...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest611
    {
        ...
        private AClassTestable611 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable611(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable611 : AClass
    {
        public AClassTestable611(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
