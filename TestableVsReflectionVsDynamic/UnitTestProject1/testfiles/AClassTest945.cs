...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest945
    {
        ...
        private AClassTestable945 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable945(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable945 : AClass
    {
        public AClassTestable945(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
