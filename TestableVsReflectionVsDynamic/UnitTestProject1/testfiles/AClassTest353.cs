...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest353
    {
        ...
        private AClassTestable353 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable353(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable353 : AClass
    {
        public AClassTestable353(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
