...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest453
    {
        ...
        private AClassTestable453 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable453(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable453 : AClass
    {
        public AClassTestable453(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
