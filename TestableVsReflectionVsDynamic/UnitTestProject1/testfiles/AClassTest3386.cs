...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3386
    {
        ...
        private AClassTestable3386 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3386(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3386 : AClass
    {
        public AClassTestable3386(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
