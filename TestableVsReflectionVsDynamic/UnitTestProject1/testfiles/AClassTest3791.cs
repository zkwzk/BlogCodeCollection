...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3791
    {
        ...
        private AClassTestable3791 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3791(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3791 : AClass
    {
        public AClassTestable3791(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
