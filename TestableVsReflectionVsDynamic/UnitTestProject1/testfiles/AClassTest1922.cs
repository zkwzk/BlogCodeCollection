...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1922
    {
        ...
        private AClassTestable1922 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1922(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1922 : AClass
    {
        public AClassTestable1922(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
