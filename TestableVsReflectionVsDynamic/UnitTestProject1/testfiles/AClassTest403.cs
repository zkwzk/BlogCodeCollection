...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest403
    {
        ...
        private AClassTestable403 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable403(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable403 : AClass
    {
        public AClassTestable403(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
