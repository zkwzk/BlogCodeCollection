...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3397
    {
        ...
        private AClassTestable3397 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3397(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3397 : AClass
    {
        public AClassTestable3397(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
