...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest665
    {
        ...
        private AClassTestable665 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable665(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable665 : AClass
    {
        public AClassTestable665(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
