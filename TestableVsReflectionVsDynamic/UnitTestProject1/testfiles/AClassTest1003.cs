...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1003
    {
        ...
        private AClassTestable1003 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1003(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1003 : AClass
    {
        public AClassTestable1003(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
