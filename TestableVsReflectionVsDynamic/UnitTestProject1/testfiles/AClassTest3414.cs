...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3414
    {
        ...
        private AClassTestable3414 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3414(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3414 : AClass
    {
        public AClassTestable3414(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
