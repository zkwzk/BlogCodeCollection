...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest392
    {
        ...
        private AClassTestable392 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable392(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable392 : AClass
    {
        public AClassTestable392(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
