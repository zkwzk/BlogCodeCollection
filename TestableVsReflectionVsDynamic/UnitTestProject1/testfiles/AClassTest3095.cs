...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3095
    {
        ...
        private AClassTestable3095 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3095(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3095 : AClass
    {
        public AClassTestable3095(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
