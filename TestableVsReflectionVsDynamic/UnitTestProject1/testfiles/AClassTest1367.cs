...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1367
    {
        ...
        private AClassTestable1367 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1367(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1367 : AClass
    {
        public AClassTestable1367(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
