...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3401
    {
        ...
        private AClassTestable3401 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3401(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3401 : AClass
    {
        public AClassTestable3401(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
