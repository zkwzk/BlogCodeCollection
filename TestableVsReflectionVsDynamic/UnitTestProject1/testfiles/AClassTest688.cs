...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest688
    {
        ...
        private AClassTestable688 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable688(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable688 : AClass
    {
        public AClassTestable688(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
