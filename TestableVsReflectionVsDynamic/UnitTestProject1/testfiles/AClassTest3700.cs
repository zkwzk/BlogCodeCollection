...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3700
    {
        ...
        private AClassTestable3700 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3700(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3700 : AClass
    {
        public AClassTestable3700(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
