...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest598
    {
        ...
        private AClassTestable598 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable598(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable598 : AClass
    {
        public AClassTestable598(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
