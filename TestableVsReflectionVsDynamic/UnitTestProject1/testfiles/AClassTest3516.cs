...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3516
    {
        ...
        private AClassTestable3516 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3516(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3516 : AClass
    {
        public AClassTestable3516(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
