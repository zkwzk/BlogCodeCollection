...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest322
    {
        ...
        private AClassTestable322 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable322(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable322 : AClass
    {
        public AClassTestable322(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
