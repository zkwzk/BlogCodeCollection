...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest896
    {
        ...
        private AClassTestable896 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable896(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable896 : AClass
    {
        public AClassTestable896(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
