...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3146
    {
        ...
        private AClassTestable3146 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3146(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3146 : AClass
    {
        public AClassTestable3146(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
