...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest629
    {
        ...
        private AClassTestable629 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable629(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable629 : AClass
    {
        public AClassTestable629(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
