...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3016
    {
        ...
        private AClassTestable3016 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3016(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3016 : AClass
    {
        public AClassTestable3016(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
