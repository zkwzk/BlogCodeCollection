...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest376
    {
        ...
        private AClassTestable376 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable376(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable376 : AClass
    {
        public AClassTestable376(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
