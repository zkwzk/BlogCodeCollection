...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest8
    {
        ...
        private AClassTestable8 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable8(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable8 : AClass
    {
        public AClassTestable8(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
