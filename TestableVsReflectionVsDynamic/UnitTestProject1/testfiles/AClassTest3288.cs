...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3288
    {
        ...
        private AClassTestable3288 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3288(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3288 : AClass
    {
        public AClassTestable3288(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
