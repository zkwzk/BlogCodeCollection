...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest982
    {
        ...
        private AClassTestable982 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable982(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable982 : AClass
    {
        public AClassTestable982(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
