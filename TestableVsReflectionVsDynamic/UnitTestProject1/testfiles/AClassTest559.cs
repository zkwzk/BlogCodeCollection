...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest559
    {
        ...
        private AClassTestable559 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable559(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable559 : AClass
    {
        public AClassTestable559(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
