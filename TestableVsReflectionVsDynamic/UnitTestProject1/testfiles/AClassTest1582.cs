...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1582
    {
        ...
        private AClassTestable1582 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1582(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1582 : AClass
    {
        public AClassTestable1582(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
