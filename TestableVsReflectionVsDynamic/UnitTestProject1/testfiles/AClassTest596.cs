...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest596
    {
        ...
        private AClassTestable596 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable596(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable596 : AClass
    {
        public AClassTestable596(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
