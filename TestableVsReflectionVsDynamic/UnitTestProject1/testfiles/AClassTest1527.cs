...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1527
    {
        ...
        private AClassTestable1527 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1527(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1527 : AClass
    {
        public AClassTestable1527(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
