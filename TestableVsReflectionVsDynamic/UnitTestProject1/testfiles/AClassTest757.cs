...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest757
    {
        ...
        private AClassTestable757 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable757(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable757 : AClass
    {
        public AClassTestable757(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
