...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1947
    {
        ...
        private AClassTestable1947 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1947(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1947 : AClass
    {
        public AClassTestable1947(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
