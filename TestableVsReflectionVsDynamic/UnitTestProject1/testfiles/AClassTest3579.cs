...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3579
    {
        ...
        private AClassTestable3579 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3579(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3579 : AClass
    {
        public AClassTestable3579(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
