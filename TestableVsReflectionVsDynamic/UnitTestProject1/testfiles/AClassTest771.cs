...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest771
    {
        ...
        private AClassTestable771 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable771(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable771 : AClass
    {
        public AClassTestable771(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
