...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest587
    {
        ...
        private AClassTestable587 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable587(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable587 : AClass
    {
        public AClassTestable587(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
