...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest914
    {
        ...
        private AClassTestable914 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable914(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable914 : AClass
    {
        public AClassTestable914(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
