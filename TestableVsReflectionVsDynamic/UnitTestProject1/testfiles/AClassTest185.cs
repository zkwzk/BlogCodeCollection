...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest185
    {
        ...
        private AClassTestable185 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable185(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable185 : AClass
    {
        public AClassTestable185(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
