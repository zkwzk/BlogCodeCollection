...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest413
    {
        ...
        private AClassTestable413 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable413(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable413 : AClass
    {
        public AClassTestable413(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
