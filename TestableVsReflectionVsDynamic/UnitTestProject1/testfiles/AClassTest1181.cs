...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1181
    {
        ...
        private AClassTestable1181 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1181(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1181 : AClass
    {
        public AClassTestable1181(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
