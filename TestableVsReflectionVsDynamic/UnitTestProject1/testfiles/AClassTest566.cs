...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest566
    {
        ...
        private AClassTestable566 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable566(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable566 : AClass
    {
        public AClassTestable566(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
