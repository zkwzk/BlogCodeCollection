...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest461
    {
        ...
        private AClassTestable461 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable461(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable461 : AClass
    {
        public AClassTestable461(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
