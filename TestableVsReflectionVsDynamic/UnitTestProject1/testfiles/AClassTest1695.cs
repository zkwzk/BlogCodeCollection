...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1695
    {
        ...
        private AClassTestable1695 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1695(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1695 : AClass
    {
        public AClassTestable1695(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
