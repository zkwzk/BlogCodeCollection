...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest571
    {
        ...
        private AClassTestable571 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable571(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable571 : AClass
    {
        public AClassTestable571(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
