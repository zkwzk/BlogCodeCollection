...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3256
    {
        ...
        private AClassTestable3256 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3256(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3256 : AClass
    {
        public AClassTestable3256(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
