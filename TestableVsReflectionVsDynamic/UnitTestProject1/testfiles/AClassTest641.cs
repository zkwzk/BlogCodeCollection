...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest641
    {
        ...
        private AClassTestable641 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable641(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable641 : AClass
    {
        public AClassTestable641(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
