...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest508
    {
        ...
        private AClassTestable508 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable508(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable508 : AClass
    {
        public AClassTestable508(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
