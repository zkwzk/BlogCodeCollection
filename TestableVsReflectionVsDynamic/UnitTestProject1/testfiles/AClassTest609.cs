...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest609
    {
        ...
        private AClassTestable609 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable609(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable609 : AClass
    {
        public AClassTestable609(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
