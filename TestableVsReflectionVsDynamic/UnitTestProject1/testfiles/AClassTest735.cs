...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest735
    {
        ...
        private AClassTestable735 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable735(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable735 : AClass
    {
        public AClassTestable735(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
