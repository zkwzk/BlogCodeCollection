...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest7
    {
        ...
        private AClassTestable7 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable7(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable7 : AClass
    {
        public AClassTestable7(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
