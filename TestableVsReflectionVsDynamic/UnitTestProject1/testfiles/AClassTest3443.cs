...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3443
    {
        ...
        private AClassTestable3443 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3443(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3443 : AClass
    {
        public AClassTestable3443(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
