...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3100
    {
        ...
        private AClassTestable3100 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3100(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3100 : AClass
    {
        public AClassTestable3100(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
