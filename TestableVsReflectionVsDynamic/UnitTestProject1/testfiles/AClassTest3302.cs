...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3302
    {
        ...
        private AClassTestable3302 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3302(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3302 : AClass
    {
        public AClassTestable3302(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
