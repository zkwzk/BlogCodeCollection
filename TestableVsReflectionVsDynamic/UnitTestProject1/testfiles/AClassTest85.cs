...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest85
    {
        ...
        private AClassTestable85 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable85(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable85 : AClass
    {
        public AClassTestable85(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
