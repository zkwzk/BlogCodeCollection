...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1749
    {
        ...
        private AClassTestable1749 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1749(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1749 : AClass
    {
        public AClassTestable1749(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
