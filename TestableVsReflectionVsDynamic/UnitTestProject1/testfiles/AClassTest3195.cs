...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3195
    {
        ...
        private AClassTestable3195 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3195(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3195 : AClass
    {
        public AClassTestable3195(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
