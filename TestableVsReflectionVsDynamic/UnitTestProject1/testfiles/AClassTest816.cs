...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest816
    {
        ...
        private AClassTestable816 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable816(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable816 : AClass
    {
        public AClassTestable816(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
