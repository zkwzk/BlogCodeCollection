...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3164
    {
        ...
        private AClassTestable3164 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3164(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3164 : AClass
    {
        public AClassTestable3164(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
