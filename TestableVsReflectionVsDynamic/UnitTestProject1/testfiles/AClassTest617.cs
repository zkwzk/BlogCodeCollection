...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest617
    {
        ...
        private AClassTestable617 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable617(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable617 : AClass
    {
        public AClassTestable617(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
