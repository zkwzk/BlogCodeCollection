...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest486
    {
        ...
        private AClassTestable486 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable486(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable486 : AClass
    {
        public AClassTestable486(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
