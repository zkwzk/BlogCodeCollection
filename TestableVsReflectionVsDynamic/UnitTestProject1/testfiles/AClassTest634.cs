...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest634
    {
        ...
        private AClassTestable634 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable634(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable634 : AClass
    {
        public AClassTestable634(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
