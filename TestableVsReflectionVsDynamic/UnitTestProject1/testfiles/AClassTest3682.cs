...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3682
    {
        ...
        private AClassTestable3682 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3682(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3682 : AClass
    {
        public AClassTestable3682(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
