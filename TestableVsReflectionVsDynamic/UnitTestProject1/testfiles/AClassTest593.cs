...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest593
    {
        ...
        private AClassTestable593 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable593(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable593 : AClass
    {
        public AClassTestable593(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
