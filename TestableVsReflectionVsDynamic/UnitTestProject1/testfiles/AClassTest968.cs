...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest968
    {
        ...
        private AClassTestable968 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable968(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable968 : AClass
    {
        public AClassTestable968(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
