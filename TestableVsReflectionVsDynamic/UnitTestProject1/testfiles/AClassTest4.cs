...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest4
    {
        ...
        private AClassTestable4 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable4(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable4 : AClass
    {
        public AClassTestable4(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
