...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest165
    {
        ...
        private AClassTestable165 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable165(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable165 : AClass
    {
        public AClassTestable165(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
