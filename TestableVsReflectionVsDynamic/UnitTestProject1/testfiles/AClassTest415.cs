...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest415
    {
        ...
        private AClassTestable415 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable415(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable415 : AClass
    {
        public AClassTestable415(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
