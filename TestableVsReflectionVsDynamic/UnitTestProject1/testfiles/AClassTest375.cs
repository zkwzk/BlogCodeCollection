...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest375
    {
        ...
        private AClassTestable375 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable375(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable375 : AClass
    {
        public AClassTestable375(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
