...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1764
    {
        ...
        private AClassTestable1764 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1764(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1764 : AClass
    {
        public AClassTestable1764(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
