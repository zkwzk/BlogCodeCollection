...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest831
    {
        ...
        private AClassTestable831 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable831(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable831 : AClass
    {
        public AClassTestable831(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
