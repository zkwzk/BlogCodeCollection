...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest633
    {
        ...
        private AClassTestable633 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable633(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable633 : AClass
    {
        public AClassTestable633(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
