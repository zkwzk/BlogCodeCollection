...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest320
    {
        ...
        private AClassTestable320 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable320(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable320 : AClass
    {
        public AClassTestable320(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
