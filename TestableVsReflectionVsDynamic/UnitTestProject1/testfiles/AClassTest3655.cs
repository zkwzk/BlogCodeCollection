...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3655
    {
        ...
        private AClassTestable3655 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3655(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3655 : AClass
    {
        public AClassTestable3655(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
