...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest327
    {
        ...
        private AClassTestable327 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable327(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable327 : AClass
    {
        public AClassTestable327(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
