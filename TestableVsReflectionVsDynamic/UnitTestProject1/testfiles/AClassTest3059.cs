...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3059
    {
        ...
        private AClassTestable3059 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3059(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3059 : AClass
    {
        public AClassTestable3059(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
