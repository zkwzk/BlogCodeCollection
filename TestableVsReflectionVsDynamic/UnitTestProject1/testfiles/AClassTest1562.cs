...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1562
    {
        ...
        private AClassTestable1562 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1562(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1562 : AClass
    {
        public AClassTestable1562(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
