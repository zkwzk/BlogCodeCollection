...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest155
    {
        ...
        private AClassTestable155 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable155(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable155 : AClass
    {
        public AClassTestable155(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
