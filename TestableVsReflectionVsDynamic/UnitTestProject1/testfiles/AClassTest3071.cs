...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3071
    {
        ...
        private AClassTestable3071 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3071(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3071 : AClass
    {
        public AClassTestable3071(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
