...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3187
    {
        ...
        private AClassTestable3187 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3187(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3187 : AClass
    {
        public AClassTestable3187(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
