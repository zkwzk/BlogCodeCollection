...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest781
    {
        ...
        private AClassTestable781 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable781(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable781 : AClass
    {
        public AClassTestable781(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
