...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3081
    {
        ...
        private AClassTestable3081 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3081(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3081 : AClass
    {
        public AClassTestable3081(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
