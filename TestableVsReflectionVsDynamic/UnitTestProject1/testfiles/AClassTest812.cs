...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest812
    {
        ...
        private AClassTestable812 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable812(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable812 : AClass
    {
        public AClassTestable812(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
