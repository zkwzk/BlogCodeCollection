...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3179
    {
        ...
        private AClassTestable3179 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3179(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3179 : AClass
    {
        public AClassTestable3179(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
