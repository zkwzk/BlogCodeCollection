...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest195
    {
        ...
        private AClassTestable195 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable195(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable195 : AClass
    {
        public AClassTestable195(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
