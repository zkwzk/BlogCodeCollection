...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest898
    {
        ...
        private AClassTestable898 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable898(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable898 : AClass
    {
        public AClassTestable898(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
