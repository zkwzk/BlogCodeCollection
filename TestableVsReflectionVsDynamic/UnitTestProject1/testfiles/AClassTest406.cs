...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest406
    {
        ...
        private AClassTestable406 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable406(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable406 : AClass
    {
        public AClassTestable406(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
