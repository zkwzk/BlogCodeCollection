...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest276
    {
        ...
        private AClassTestable276 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable276(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable276 : AClass
    {
        public AClassTestable276(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
