...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest323
    {
        ...
        private AClassTestable323 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable323(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable323 : AClass
    {
        public AClassTestable323(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
