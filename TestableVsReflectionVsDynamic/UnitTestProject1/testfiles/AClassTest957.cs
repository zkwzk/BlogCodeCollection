...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest957
    {
        ...
        private AClassTestable957 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable957(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable957 : AClass
    {
        public AClassTestable957(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
