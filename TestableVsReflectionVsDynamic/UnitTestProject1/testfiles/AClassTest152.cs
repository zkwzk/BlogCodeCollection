...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest152
    {
        ...
        private AClassTestable152 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable152(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable152 : AClass
    {
        public AClassTestable152(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
