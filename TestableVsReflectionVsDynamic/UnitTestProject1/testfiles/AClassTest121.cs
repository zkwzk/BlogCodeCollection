...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest121
    {
        ...
        private AClassTestable121 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable121(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable121 : AClass
    {
        public AClassTestable121(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
