...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest473
    {
        ...
        private AClassTestable473 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable473(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable473 : AClass
    {
        public AClassTestable473(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
