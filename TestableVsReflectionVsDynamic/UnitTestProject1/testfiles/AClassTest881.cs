...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest881
    {
        ...
        private AClassTestable881 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable881(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable881 : AClass
    {
        public AClassTestable881(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
