...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3818
    {
        ...
        private AClassTestable3818 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3818(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3818 : AClass
    {
        public AClassTestable3818(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
