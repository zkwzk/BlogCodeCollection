...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest825
    {
        ...
        private AClassTestable825 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable825(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable825 : AClass
    {
        public AClassTestable825(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
