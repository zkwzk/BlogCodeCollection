...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest696
    {
        ...
        private AClassTestable696 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable696(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable696 : AClass
    {
        public AClassTestable696(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
