...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest60
    {
        ...
        private AClassTestable60 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable60(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable60 : AClass
    {
        public AClassTestable60(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
