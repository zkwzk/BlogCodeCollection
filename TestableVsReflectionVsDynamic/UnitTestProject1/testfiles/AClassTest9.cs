...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest9
    {
        ...
        private AClassTestable9 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable9(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable9 : AClass
    {
        public AClassTestable9(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
