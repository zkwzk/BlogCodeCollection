...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3851
    {
        ...
        private AClassTestable3851 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3851(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3851 : AClass
    {
        public AClassTestable3851(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
