...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3793
    {
        ...
        private AClassTestable3793 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3793(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3793 : AClass
    {
        public AClassTestable3793(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
