...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest448
    {
        ...
        private AClassTestable448 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable448(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable448 : AClass
    {
        public AClassTestable448(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
