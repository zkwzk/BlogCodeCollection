...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3905
    {
        ...
        private AClassTestable3905 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3905(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3905 : AClass
    {
        public AClassTestable3905(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
