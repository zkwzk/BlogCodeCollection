...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest421
    {
        ...
        private AClassTestable421 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable421(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable421 : AClass
    {
        public AClassTestable421(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
