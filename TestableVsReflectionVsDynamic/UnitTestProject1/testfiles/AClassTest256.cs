...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest256
    {
        ...
        private AClassTestable256 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable256(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable256 : AClass
    {
        public AClassTestable256(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
