...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3142
    {
        ...
        private AClassTestable3142 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3142(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3142 : AClass
    {
        public AClassTestable3142(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
