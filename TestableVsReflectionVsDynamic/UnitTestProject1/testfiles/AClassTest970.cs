...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest970
    {
        ...
        private AClassTestable970 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable970(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable970 : AClass
    {
        public AClassTestable970(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
