...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1705
    {
        ...
        private AClassTestable1705 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1705(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1705 : AClass
    {
        public AClassTestable1705(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
