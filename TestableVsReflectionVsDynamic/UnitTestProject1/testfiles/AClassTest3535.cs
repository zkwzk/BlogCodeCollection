...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3535
    {
        ...
        private AClassTestable3535 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3535(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3535 : AClass
    {
        public AClassTestable3535(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
