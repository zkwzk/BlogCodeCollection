...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest643
    {
        ...
        private AClassTestable643 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable643(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable643 : AClass
    {
        public AClassTestable643(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
