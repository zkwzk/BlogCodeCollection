...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest810
    {
        ...
        private AClassTestable810 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable810(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable810 : AClass
    {
        public AClassTestable810(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
