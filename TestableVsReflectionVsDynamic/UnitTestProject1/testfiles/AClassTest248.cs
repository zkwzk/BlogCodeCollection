...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest248
    {
        ...
        private AClassTestable248 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable248(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable248 : AClass
    {
        public AClassTestable248(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
