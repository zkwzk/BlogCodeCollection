...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3959
    {
        ...
        private AClassTestable3959 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3959(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3959 : AClass
    {
        public AClassTestable3959(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
