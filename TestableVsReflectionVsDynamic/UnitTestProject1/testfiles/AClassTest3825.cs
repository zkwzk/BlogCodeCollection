...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3825
    {
        ...
        private AClassTestable3825 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3825(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3825 : AClass
    {
        public AClassTestable3825(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
