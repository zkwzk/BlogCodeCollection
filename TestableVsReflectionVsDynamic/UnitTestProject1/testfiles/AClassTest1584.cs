...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1584
    {
        ...
        private AClassTestable1584 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1584(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1584 : AClass
    {
        public AClassTestable1584(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
