...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3000
    {
        ...
        private AClassTestable3000 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3000(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3000 : AClass
    {
        public AClassTestable3000(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
