...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest923
    {
        ...
        private AClassTestable923 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable923(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable923 : AClass
    {
        public AClassTestable923(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
