...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest286
    {
        ...
        private AClassTestable286 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable286(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable286 : AClass
    {
        public AClassTestable286(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
