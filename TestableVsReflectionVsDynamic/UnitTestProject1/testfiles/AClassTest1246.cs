...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1246
    {
        ...
        private AClassTestable1246 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1246(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1246 : AClass
    {
        public AClassTestable1246(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
