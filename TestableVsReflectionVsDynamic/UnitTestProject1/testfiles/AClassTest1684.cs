...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1684
    {
        ...
        private AClassTestable1684 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1684(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1684 : AClass
    {
        public AClassTestable1684(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
