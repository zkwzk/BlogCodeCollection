...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1990
    {
        ...
        private AClassTestable1990 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1990(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1990 : AClass
    {
        public AClassTestable1990(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
