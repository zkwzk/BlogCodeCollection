...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest708
    {
        ...
        private AClassTestable708 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable708(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable708 : AClass
    {
        public AClassTestable708(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
