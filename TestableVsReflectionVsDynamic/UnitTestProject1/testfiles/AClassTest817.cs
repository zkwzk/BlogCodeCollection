...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest817
    {
        ...
        private AClassTestable817 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable817(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable817 : AClass
    {
        public AClassTestable817(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
