...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1476
    {
        ...
        private AClassTestable1476 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1476(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1476 : AClass
    {
        public AClassTestable1476(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
