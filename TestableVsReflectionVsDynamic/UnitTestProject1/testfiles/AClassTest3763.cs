...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3763
    {
        ...
        private AClassTestable3763 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3763(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3763 : AClass
    {
        public AClassTestable3763(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
