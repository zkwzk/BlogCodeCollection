...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest906
    {
        ...
        private AClassTestable906 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable906(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable906 : AClass
    {
        public AClassTestable906(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
