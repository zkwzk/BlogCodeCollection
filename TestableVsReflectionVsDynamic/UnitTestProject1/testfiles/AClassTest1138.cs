...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1138
    {
        ...
        private AClassTestable1138 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1138(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1138 : AClass
    {
        public AClassTestable1138(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
