...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest450
    {
        ...
        private AClassTestable450 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable450(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable450 : AClass
    {
        public AClassTestable450(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
