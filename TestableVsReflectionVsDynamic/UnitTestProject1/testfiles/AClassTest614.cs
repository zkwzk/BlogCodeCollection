...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest614
    {
        ...
        private AClassTestable614 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable614(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable614 : AClass
    {
        public AClassTestable614(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
