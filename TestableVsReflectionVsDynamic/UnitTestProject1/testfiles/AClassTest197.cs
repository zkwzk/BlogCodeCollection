...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest197
    {
        ...
        private AClassTestable197 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable197(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable197 : AClass
    {
        public AClassTestable197(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
