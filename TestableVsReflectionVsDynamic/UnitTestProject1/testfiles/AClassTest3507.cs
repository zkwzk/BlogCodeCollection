...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3507
    {
        ...
        private AClassTestable3507 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3507(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3507 : AClass
    {
        public AClassTestable3507(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
