...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3258
    {
        ...
        private AClassTestable3258 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3258(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3258 : AClass
    {
        public AClassTestable3258(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
