...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1754
    {
        ...
        private AClassTestable1754 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1754(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1754 : AClass
    {
        public AClassTestable1754(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
