...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3901
    {
        ...
        private AClassTestable3901 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3901(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3901 : AClass
    {
        public AClassTestable3901(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
