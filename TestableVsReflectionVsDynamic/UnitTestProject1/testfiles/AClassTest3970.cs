...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3970
    {
        ...
        private AClassTestable3970 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3970(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3970 : AClass
    {
        public AClassTestable3970(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
