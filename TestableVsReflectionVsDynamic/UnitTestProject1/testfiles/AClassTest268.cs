...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest268
    {
        ...
        private AClassTestable268 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable268(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable268 : AClass
    {
        public AClassTestable268(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
