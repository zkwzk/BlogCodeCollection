...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest378
    {
        ...
        private AClassTestable378 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable378(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable378 : AClass
    {
        public AClassTestable378(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
