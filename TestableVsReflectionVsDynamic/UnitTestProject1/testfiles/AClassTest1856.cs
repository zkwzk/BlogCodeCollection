...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1856
    {
        ...
        private AClassTestable1856 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1856(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1856 : AClass
    {
        public AClassTestable1856(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
