...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3407
    {
        ...
        private AClassTestable3407 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3407(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3407 : AClass
    {
        public AClassTestable3407(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
