...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3607
    {
        ...
        private AClassTestable3607 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3607(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3607 : AClass
    {
        public AClassTestable3607(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
