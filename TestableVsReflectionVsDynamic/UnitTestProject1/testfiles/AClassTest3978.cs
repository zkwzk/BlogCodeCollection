...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3978
    {
        ...
        private AClassTestable3978 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3978(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3978 : AClass
    {
        public AClassTestable3978(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
