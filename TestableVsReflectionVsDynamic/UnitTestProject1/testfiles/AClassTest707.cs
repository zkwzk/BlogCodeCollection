...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest707
    {
        ...
        private AClassTestable707 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable707(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable707 : AClass
    {
        public AClassTestable707(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
