...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest961
    {
        ...
        private AClassTestable961 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable961(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable961 : AClass
    {
        public AClassTestable961(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
