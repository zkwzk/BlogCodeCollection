...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest334
    {
        ...
        private AClassTestable334 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable334(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable334 : AClass
    {
        public AClassTestable334(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
