...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest994
    {
        ...
        private AClassTestable994 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable994(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable994 : AClass
    {
        public AClassTestable994(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
