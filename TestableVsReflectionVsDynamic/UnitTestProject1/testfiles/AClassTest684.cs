...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest684
    {
        ...
        private AClassTestable684 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable684(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable684 : AClass
    {
        public AClassTestable684(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
