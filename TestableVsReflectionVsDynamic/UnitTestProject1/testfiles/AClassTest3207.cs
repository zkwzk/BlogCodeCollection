...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3207
    {
        ...
        private AClassTestable3207 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3207(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3207 : AClass
    {
        public AClassTestable3207(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
