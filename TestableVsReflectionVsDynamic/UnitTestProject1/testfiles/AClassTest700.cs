...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest700
    {
        ...
        private AClassTestable700 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable700(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable700 : AClass
    {
        public AClassTestable700(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
