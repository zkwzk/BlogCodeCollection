...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest354
    {
        ...
        private AClassTestable354 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable354(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable354 : AClass
    {
        public AClassTestable354(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
