...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest302
    {
        ...
        private AClassTestable302 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable302(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable302 : AClass
    {
        public AClassTestable302(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
