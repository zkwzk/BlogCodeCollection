...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest31
    {
        ...
        private AClassTestable31 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable31(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable31 : AClass
    {
        public AClassTestable31(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
