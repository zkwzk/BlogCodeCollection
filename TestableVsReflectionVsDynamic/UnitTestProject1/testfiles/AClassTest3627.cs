...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3627
    {
        ...
        private AClassTestable3627 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3627(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3627 : AClass
    {
        public AClassTestable3627(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
