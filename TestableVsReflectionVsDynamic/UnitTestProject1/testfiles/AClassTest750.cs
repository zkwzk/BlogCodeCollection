...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest750
    {
        ...
        private AClassTestable750 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable750(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable750 : AClass
    {
        public AClassTestable750(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
