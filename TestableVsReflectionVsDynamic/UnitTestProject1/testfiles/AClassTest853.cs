...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest853
    {
        ...
        private AClassTestable853 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable853(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable853 : AClass
    {
        public AClassTestable853(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
