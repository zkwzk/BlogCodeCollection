...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3892
    {
        ...
        private AClassTestable3892 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3892(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3892 : AClass
    {
        public AClassTestable3892(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
