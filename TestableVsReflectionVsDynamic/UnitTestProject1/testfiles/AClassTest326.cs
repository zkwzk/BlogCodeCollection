...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest326
    {
        ...
        private AClassTestable326 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable326(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable326 : AClass
    {
        public AClassTestable326(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
