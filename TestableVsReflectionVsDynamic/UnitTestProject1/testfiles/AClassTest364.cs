...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest364
    {
        ...
        private AClassTestable364 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable364(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable364 : AClass
    {
        public AClassTestable364(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
