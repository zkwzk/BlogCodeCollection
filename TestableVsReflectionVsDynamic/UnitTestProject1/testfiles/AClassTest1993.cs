...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1993
    {
        ...
        private AClassTestable1993 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1993(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1993 : AClass
    {
        public AClassTestable1993(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
