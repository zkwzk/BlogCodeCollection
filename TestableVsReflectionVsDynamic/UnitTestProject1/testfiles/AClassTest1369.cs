...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1369
    {
        ...
        private AClassTestable1369 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1369(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1369 : AClass
    {
        public AClassTestable1369(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
