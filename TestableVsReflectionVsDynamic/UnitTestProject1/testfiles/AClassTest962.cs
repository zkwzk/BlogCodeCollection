...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest962
    {
        ...
        private AClassTestable962 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable962(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable962 : AClass
    {
        public AClassTestable962(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
