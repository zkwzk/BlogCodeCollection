...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest292
    {
        ...
        private AClassTestable292 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable292(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable292 : AClass
    {
        public AClassTestable292(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
