...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest253
    {
        ...
        private AClassTestable253 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable253(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable253 : AClass
    {
        public AClassTestable253(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
