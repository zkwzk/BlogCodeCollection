...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest511
    {
        ...
        private AClassTestable511 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable511(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable511 : AClass
    {
        public AClassTestable511(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
