...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest676
    {
        ...
        private AClassTestable676 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable676(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable676 : AClass
    {
        public AClassTestable676(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
