...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest366
    {
        ...
        private AClassTestable366 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable366(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable366 : AClass
    {
        public AClassTestable366(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
