...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest192
    {
        ...
        private AClassTestable192 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable192(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable192 : AClass
    {
        public AClassTestable192(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
