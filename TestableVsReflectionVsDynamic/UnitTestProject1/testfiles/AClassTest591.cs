...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest591
    {
        ...
        private AClassTestable591 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable591(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable591 : AClass
    {
        public AClassTestable591(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
