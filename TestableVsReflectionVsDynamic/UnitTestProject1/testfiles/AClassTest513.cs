...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest513
    {
        ...
        private AClassTestable513 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable513(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable513 : AClass
    {
        public AClassTestable513(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
