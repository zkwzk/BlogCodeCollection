...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1857
    {
        ...
        private AClassTestable1857 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1857(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1857 : AClass
    {
        public AClassTestable1857(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
