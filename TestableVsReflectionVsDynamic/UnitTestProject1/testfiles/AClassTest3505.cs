...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3505
    {
        ...
        private AClassTestable3505 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3505(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3505 : AClass
    {
        public AClassTestable3505(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
