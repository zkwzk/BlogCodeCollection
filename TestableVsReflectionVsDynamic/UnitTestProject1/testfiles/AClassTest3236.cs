...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3236
    {
        ...
        private AClassTestable3236 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3236(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3236 : AClass
    {
        public AClassTestable3236(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
