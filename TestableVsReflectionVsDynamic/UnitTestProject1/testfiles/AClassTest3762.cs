...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3762
    {
        ...
        private AClassTestable3762 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3762(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3762 : AClass
    {
        public AClassTestable3762(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
