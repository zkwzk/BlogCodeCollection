...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest84
    {
        ...
        private AClassTestable84 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable84(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable84 : AClass
    {
        public AClassTestable84(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
