...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest345
    {
        ...
        private AClassTestable345 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable345(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable345 : AClass
    {
        public AClassTestable345(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
