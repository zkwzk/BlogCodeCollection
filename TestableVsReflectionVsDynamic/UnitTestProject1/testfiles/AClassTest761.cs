...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest761
    {
        ...
        private AClassTestable761 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable761(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable761 : AClass
    {
        public AClassTestable761(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
