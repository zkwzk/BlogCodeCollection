...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest671
    {
        ...
        private AClassTestable671 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable671(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable671 : AClass
    {
        public AClassTestable671(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
