...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3824
    {
        ...
        private AClassTestable3824 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3824(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3824 : AClass
    {
        public AClassTestable3824(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
