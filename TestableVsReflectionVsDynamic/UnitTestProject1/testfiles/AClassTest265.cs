...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest265
    {
        ...
        private AClassTestable265 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable265(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable265 : AClass
    {
        public AClassTestable265(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
