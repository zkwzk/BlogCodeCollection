...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3389
    {
        ...
        private AClassTestable3389 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3389(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3389 : AClass
    {
        public AClassTestable3389(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
