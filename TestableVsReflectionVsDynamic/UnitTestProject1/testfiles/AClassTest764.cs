...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest764
    {
        ...
        private AClassTestable764 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable764(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable764 : AClass
    {
        public AClassTestable764(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
