...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest863
    {
        ...
        private AClassTestable863 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable863(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable863 : AClass
    {
        public AClassTestable863(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
