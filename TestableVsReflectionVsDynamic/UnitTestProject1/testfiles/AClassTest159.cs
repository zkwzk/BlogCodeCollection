...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest159
    {
        ...
        private AClassTestable159 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable159(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable159 : AClass
    {
        public AClassTestable159(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
