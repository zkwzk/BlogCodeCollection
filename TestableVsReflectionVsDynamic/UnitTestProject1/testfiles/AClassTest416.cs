...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest416
    {
        ...
        private AClassTestable416 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable416(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable416 : AClass
    {
        public AClassTestable416(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
