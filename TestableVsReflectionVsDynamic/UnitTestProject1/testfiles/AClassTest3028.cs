...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3028
    {
        ...
        private AClassTestable3028 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3028(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3028 : AClass
    {
        public AClassTestable3028(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
