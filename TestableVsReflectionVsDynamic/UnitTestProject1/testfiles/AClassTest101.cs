...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest101
    {
        ...
        private AClassTestable101 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable101(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable101 : AClass
    {
        public AClassTestable101(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
