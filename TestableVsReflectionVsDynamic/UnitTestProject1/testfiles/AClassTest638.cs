...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest638
    {
        ...
        private AClassTestable638 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable638(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable638 : AClass
    {
        public AClassTestable638(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
