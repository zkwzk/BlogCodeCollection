...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3916
    {
        ...
        private AClassTestable3916 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3916(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3916 : AClass
    {
        public AClassTestable3916(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
