...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest667
    {
        ...
        private AClassTestable667 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable667(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable667 : AClass
    {
        public AClassTestable667(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
