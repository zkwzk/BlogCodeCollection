...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest714
    {
        ...
        private AClassTestable714 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable714(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable714 : AClass
    {
        public AClassTestable714(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
