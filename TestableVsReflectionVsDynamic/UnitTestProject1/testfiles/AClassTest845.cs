...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest845
    {
        ...
        private AClassTestable845 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable845(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable845 : AClass
    {
        public AClassTestable845(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
