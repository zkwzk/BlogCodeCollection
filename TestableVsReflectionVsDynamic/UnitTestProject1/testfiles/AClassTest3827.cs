...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3827
    {
        ...
        private AClassTestable3827 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3827(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3827 : AClass
    {
        public AClassTestable3827(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
