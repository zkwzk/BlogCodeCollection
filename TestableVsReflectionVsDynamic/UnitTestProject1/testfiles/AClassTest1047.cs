...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1047
    {
        ...
        private AClassTestable1047 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1047(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1047 : AClass
    {
        public AClassTestable1047(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
