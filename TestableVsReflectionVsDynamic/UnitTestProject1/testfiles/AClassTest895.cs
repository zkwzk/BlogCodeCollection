...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest895
    {
        ...
        private AClassTestable895 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable895(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable895 : AClass
    {
        public AClassTestable895(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
