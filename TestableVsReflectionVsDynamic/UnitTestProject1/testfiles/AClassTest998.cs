...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest998
    {
        ...
        private AClassTestable998 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable998(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable998 : AClass
    {
        public AClassTestable998(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
