...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3307
    {
        ...
        private AClassTestable3307 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3307(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3307 : AClass
    {
        public AClassTestable3307(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
