...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest404
    {
        ...
        private AClassTestable404 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable404(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable404 : AClass
    {
        public AClassTestable404(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
