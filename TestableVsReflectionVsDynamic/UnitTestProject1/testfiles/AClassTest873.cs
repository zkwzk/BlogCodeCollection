...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest873
    {
        ...
        private AClassTestable873 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable873(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable873 : AClass
    {
        public AClassTestable873(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
