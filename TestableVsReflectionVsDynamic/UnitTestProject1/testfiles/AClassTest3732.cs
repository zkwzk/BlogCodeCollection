...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3732
    {
        ...
        private AClassTestable3732 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3732(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3732 : AClass
    {
        public AClassTestable3732(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
