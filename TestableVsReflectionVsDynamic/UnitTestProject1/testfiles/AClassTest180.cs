...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest180
    {
        ...
        private AClassTestable180 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable180(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable180 : AClass
    {
        public AClassTestable180(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
