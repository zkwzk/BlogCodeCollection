...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest441
    {
        ...
        private AClassTestable441 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable441(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable441 : AClass
    {
        public AClassTestable441(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
