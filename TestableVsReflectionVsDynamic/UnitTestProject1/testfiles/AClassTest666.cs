...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest666
    {
        ...
        private AClassTestable666 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable666(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable666 : AClass
    {
        public AClassTestable666(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
