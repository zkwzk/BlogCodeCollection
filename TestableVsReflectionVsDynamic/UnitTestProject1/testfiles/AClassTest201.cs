...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest201
    {
        ...
        private AClassTestable201 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable201(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable201 : AClass
    {
        public AClassTestable201(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
