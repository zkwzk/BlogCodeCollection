...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1460
    {
        ...
        private AClassTestable1460 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1460(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1460 : AClass
    {
        public AClassTestable1460(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
