...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest773
    {
        ...
        private AClassTestable773 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable773(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable773 : AClass
    {
        public AClassTestable773(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
