...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1899
    {
        ...
        private AClassTestable1899 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1899(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1899 : AClass
    {
        public AClassTestable1899(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
