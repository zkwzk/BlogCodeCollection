...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3780
    {
        ...
        private AClassTestable3780 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3780(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3780 : AClass
    {
        public AClassTestable3780(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
