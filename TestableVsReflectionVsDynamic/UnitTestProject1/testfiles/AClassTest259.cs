...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest259
    {
        ...
        private AClassTestable259 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable259(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable259 : AClass
    {
        public AClassTestable259(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
