...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3630
    {
        ...
        private AClassTestable3630 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3630(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3630 : AClass
    {
        public AClassTestable3630(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
