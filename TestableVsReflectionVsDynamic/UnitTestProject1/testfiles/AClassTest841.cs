...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest841
    {
        ...
        private AClassTestable841 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable841(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable841 : AClass
    {
        public AClassTestable841(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
