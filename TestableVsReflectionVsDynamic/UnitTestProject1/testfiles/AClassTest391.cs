...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest391
    {
        ...
        private AClassTestable391 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable391(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable391 : AClass
    {
        public AClassTestable391(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
