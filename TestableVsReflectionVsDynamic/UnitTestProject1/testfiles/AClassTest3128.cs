...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3128
    {
        ...
        private AClassTestable3128 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3128(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3128 : AClass
    {
        public AClassTestable3128(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
