...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest263
    {
        ...
        private AClassTestable263 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable263(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable263 : AClass
    {
        public AClassTestable263(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
