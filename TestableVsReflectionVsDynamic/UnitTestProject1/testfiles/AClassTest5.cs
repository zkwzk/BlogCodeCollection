...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest5
    {
        ...
        private AClassTestable5 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable5(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable5 : AClass
    {
        public AClassTestable5(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
