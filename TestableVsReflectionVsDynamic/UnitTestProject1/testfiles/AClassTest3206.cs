...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3206
    {
        ...
        private AClassTestable3206 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3206(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3206 : AClass
    {
        public AClassTestable3206(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
