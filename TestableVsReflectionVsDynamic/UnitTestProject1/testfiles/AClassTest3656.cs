...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3656
    {
        ...
        private AClassTestable3656 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3656(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3656 : AClass
    {
        public AClassTestable3656(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
