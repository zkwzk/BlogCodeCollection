...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest826
    {
        ...
        private AClassTestable826 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable826(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable826 : AClass
    {
        public AClassTestable826(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
