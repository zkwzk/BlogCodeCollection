...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1107
    {
        ...
        private AClassTestable1107 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1107(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1107 : AClass
    {
        public AClassTestable1107(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
