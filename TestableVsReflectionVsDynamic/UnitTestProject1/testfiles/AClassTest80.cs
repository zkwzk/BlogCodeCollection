...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest80
    {
        ...
        private AClassTestable80 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable80(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable80 : AClass
    {
        public AClassTestable80(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
