...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3427
    {
        ...
        private AClassTestable3427 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3427(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3427 : AClass
    {
        public AClassTestable3427(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
