...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3461
    {
        ...
        private AClassTestable3461 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3461(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3461 : AClass
    {
        public AClassTestable3461(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
