...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest319
    {
        ...
        private AClassTestable319 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable319(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable319 : AClass
    {
        public AClassTestable319(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
