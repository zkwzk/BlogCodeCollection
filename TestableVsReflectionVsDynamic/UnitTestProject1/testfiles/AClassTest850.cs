...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest850
    {
        ...
        private AClassTestable850 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable850(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable850 : AClass
    {
        public AClassTestable850(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
