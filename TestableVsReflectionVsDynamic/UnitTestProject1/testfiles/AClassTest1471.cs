...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1471
    {
        ...
        private AClassTestable1471 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1471(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1471 : AClass
    {
        public AClassTestable1471(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
