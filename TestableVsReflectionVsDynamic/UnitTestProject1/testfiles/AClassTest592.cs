...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest592
    {
        ...
        private AClassTestable592 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable592(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable592 : AClass
    {
        public AClassTestable592(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
