...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest953
    {
        ...
        private AClassTestable953 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable953(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable953 : AClass
    {
        public AClassTestable953(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
