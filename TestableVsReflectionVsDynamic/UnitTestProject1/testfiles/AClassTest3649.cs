...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3649
    {
        ...
        private AClassTestable3649 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3649(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3649 : AClass
    {
        public AClassTestable3649(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
