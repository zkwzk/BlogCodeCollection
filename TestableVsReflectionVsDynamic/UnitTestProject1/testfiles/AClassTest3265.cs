...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3265
    {
        ...
        private AClassTestable3265 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3265(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3265 : AClass
    {
        public AClassTestable3265(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
