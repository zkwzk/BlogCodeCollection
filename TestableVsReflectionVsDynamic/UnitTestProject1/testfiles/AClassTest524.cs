...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest524
    {
        ...
        private AClassTestable524 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable524(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable524 : AClass
    {
        public AClassTestable524(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
