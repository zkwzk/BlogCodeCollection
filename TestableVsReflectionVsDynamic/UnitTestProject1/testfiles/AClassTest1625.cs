...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1625
    {
        ...
        private AClassTestable1625 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1625(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1625 : AClass
    {
        public AClassTestable1625(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
