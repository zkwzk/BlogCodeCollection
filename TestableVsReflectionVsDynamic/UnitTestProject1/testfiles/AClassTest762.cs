...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest762
    {
        ...
        private AClassTestable762 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable762(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable762 : AClass
    {
        public AClassTestable762(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
