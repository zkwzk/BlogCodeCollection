...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest646
    {
        ...
        private AClassTestable646 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable646(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable646 : AClass
    {
        public AClassTestable646(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
