...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3411
    {
        ...
        private AClassTestable3411 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3411(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3411 : AClass
    {
        public AClassTestable3411(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
