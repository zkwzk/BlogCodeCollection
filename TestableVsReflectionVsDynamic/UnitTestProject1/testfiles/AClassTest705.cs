...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest705
    {
        ...
        private AClassTestable705 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable705(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable705 : AClass
    {
        public AClassTestable705(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
