...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3677
    {
        ...
        private AClassTestable3677 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3677(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3677 : AClass
    {
        public AClassTestable3677(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
