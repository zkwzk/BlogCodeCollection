...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1372
    {
        ...
        private AClassTestable1372 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1372(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1372 : AClass
    {
        public AClassTestable1372(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
