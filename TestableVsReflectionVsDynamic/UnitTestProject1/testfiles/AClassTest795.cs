...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest795
    {
        ...
        private AClassTestable795 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable795(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable795 : AClass
    {
        public AClassTestable795(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
