...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1087
    {
        ...
        private AClassTestable1087 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1087(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1087 : AClass
    {
        public AClassTestable1087(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
