...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest75
    {
        ...
        private AClassTestable75 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable75(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable75 : AClass
    {
        public AClassTestable75(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
