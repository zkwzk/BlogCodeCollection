...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest460
    {
        ...
        private AClassTestable460 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable460(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable460 : AClass
    {
        public AClassTestable460(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
