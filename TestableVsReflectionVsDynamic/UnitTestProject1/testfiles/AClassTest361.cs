...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest361
    {
        ...
        private AClassTestable361 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable361(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable361 : AClass
    {
        public AClassTestable361(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
