...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest903
    {
        ...
        private AClassTestable903 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable903(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable903 : AClass
    {
        public AClassTestable903(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
