...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest786
    {
        ...
        private AClassTestable786 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable786(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable786 : AClass
    {
        public AClassTestable786(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
