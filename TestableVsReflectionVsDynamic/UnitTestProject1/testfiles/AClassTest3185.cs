...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3185
    {
        ...
        private AClassTestable3185 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3185(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3185 : AClass
    {
        public AClassTestable3185(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
