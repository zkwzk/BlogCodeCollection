...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest874
    {
        ...
        private AClassTestable874 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable874(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable874 : AClass
    {
        public AClassTestable874(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
