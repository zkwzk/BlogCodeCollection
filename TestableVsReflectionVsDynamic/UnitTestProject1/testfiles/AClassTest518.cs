...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest518
    {
        ...
        private AClassTestable518 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable518(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable518 : AClass
    {
        public AClassTestable518(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
