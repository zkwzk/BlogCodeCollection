...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest829
    {
        ...
        private AClassTestable829 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable829(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable829 : AClass
    {
        public AClassTestable829(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
