...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest536
    {
        ...
        private AClassTestable536 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable536(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable536 : AClass
    {
        public AClassTestable536(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
