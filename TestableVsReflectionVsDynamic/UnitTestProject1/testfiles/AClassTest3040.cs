...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3040
    {
        ...
        private AClassTestable3040 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3040(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3040 : AClass
    {
        public AClassTestable3040(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
