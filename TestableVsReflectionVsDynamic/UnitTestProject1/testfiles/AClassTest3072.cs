...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3072
    {
        ...
        private AClassTestable3072 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3072(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3072 : AClass
    {
        public AClassTestable3072(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
