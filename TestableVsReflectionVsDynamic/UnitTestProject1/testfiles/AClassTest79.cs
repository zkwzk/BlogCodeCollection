...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest79
    {
        ...
        private AClassTestable79 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable79(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable79 : AClass
    {
        public AClassTestable79(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
