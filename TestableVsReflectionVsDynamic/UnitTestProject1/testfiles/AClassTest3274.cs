...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3274
    {
        ...
        private AClassTestable3274 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3274(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3274 : AClass
    {
        public AClassTestable3274(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
