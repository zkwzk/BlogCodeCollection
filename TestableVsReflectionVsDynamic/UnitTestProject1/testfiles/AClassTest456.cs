...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest456
    {
        ...
        private AClassTestable456 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable456(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable456 : AClass
    {
        public AClassTestable456(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
