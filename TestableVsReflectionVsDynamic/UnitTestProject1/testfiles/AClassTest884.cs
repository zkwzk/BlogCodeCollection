...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest884
    {
        ...
        private AClassTestable884 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable884(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable884 : AClass
    {
        public AClassTestable884(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
