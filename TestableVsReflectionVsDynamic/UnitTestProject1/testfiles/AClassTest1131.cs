...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1131
    {
        ...
        private AClassTestable1131 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1131(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1131 : AClass
    {
        public AClassTestable1131(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
