...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1634
    {
        ...
        private AClassTestable1634 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1634(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1634 : AClass
    {
        public AClassTestable1634(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
