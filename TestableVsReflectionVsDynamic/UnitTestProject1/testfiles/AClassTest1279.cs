...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1279
    {
        ...
        private AClassTestable1279 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1279(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1279 : AClass
    {
        public AClassTestable1279(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
