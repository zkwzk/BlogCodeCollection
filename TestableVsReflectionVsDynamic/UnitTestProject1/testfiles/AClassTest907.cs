...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest907
    {
        ...
        private AClassTestable907 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable907(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable907 : AClass
    {
        public AClassTestable907(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
