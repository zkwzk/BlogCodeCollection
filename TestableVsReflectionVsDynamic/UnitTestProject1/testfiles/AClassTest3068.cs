...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3068
    {
        ...
        private AClassTestable3068 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3068(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3068 : AClass
    {
        public AClassTestable3068(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
