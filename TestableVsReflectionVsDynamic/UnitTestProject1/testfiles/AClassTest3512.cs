...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3512
    {
        ...
        private AClassTestable3512 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3512(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3512 : AClass
    {
        public AClassTestable3512(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
