...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest388
    {
        ...
        private AClassTestable388 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable388(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable388 : AClass
    {
        public AClassTestable388(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
