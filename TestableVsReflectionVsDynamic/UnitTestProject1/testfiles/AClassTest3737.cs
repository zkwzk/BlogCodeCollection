...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3737
    {
        ...
        private AClassTestable3737 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3737(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3737 : AClass
    {
        public AClassTestable3737(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
