...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1870
    {
        ...
        private AClassTestable1870 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1870(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1870 : AClass
    {
        public AClassTestable1870(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
