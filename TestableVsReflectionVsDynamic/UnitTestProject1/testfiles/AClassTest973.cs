...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest973
    {
        ...
        private AClassTestable973 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable973(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable973 : AClass
    {
        public AClassTestable973(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
