...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1986
    {
        ...
        private AClassTestable1986 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1986(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1986 : AClass
    {
        public AClassTestable1986(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
