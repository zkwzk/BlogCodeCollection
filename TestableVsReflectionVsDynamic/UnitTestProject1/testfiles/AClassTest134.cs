...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest134
    {
        ...
        private AClassTestable134 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable134(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable134 : AClass
    {
        public AClassTestable134(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
