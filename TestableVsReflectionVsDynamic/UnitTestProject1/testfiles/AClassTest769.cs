...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest769
    {
        ...
        private AClassTestable769 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable769(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable769 : AClass
    {
        public AClassTestable769(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
