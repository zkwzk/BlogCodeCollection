...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest313
    {
        ...
        private AClassTestable313 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable313(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable313 : AClass
    {
        public AClassTestable313(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
