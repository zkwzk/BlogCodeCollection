...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3761
    {
        ...
        private AClassTestable3761 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3761(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3761 : AClass
    {
        public AClassTestable3761(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
