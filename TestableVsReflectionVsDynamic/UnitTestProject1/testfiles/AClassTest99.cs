...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest99
    {
        ...
        private AClassTestable99 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable99(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable99 : AClass
    {
        public AClassTestable99(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
