...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest111
    {
        ...
        private AClassTestable111 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable111(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable111 : AClass
    {
        public AClassTestable111(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
