...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest701
    {
        ...
        private AClassTestable701 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable701(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable701 : AClass
    {
        public AClassTestable701(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
