...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest917
    {
        ...
        private AClassTestable917 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable917(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable917 : AClass
    {
        public AClassTestable917(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
