...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1459
    {
        ...
        private AClassTestable1459 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1459(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1459 : AClass
    {
        public AClassTestable1459(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
