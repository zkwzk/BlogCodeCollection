...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest600
    {
        ...
        private AClassTestable600 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable600(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable600 : AClass
    {
        public AClassTestable600(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
