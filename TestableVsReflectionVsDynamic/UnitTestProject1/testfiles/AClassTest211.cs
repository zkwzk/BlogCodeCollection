...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest211
    {
        ...
        private AClassTestable211 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable211(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable211 : AClass
    {
        public AClassTestable211(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
