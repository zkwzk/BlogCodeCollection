...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest954
    {
        ...
        private AClassTestable954 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable954(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable954 : AClass
    {
        public AClassTestable954(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
