...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1437
    {
        ...
        private AClassTestable1437 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1437(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1437 : AClass
    {
        public AClassTestable1437(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
