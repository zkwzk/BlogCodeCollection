...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest50
    {
        ...
        private AClassTestable50 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable50(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable50 : AClass
    {
        public AClassTestable50(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
