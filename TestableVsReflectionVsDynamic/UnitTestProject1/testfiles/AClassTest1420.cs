...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1420
    {
        ...
        private AClassTestable1420 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1420(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1420 : AClass
    {
        public AClassTestable1420(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
