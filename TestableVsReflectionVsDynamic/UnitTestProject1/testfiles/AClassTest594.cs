...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest594
    {
        ...
        private AClassTestable594 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable594(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable594 : AClass
    {
        public AClassTestable594(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
