...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest577
    {
        ...
        private AClassTestable577 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable577(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable577 : AClass
    {
        public AClassTestable577(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
