...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3600
    {
        ...
        private AClassTestable3600 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3600(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3600 : AClass
    {
        public AClassTestable3600(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
