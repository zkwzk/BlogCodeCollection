...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest864
    {
        ...
        private AClassTestable864 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable864(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable864 : AClass
    {
        public AClassTestable864(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
