...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest209
    {
        ...
        private AClassTestable209 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable209(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable209 : AClass
    {
        public AClassTestable209(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
