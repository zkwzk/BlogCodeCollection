...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1652
    {
        ...
        private AClassTestable1652 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1652(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1652 : AClass
    {
        public AClassTestable1652(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
