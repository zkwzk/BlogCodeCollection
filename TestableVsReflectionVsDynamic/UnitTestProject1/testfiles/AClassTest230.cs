...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest230
    {
        ...
        private AClassTestable230 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable230(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable230 : AClass
    {
        public AClassTestable230(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
