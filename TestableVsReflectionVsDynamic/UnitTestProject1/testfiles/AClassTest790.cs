...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest790
    {
        ...
        private AClassTestable790 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable790(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable790 : AClass
    {
        public AClassTestable790(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
