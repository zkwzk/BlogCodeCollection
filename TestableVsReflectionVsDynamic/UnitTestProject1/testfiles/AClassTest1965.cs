...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1965
    {
        ...
        private AClassTestable1965 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1965(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1965 : AClass
    {
        public AClassTestable1965(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
