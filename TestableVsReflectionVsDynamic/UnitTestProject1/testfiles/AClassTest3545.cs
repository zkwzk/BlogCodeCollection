...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3545
    {
        ...
        private AClassTestable3545 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3545(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3545 : AClass
    {
        public AClassTestable3545(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
