...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1347
    {
        ...
        private AClassTestable1347 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1347(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1347 : AClass
    {
        public AClassTestable1347(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
