...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest663
    {
        ...
        private AClassTestable663 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable663(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable663 : AClass
    {
        public AClassTestable663(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
