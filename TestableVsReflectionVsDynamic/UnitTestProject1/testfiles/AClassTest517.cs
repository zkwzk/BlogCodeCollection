...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest517
    {
        ...
        private AClassTestable517 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable517(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable517 : AClass
    {
        public AClassTestable517(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
