...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3159
    {
        ...
        private AClassTestable3159 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3159(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3159 : AClass
    {
        public AClassTestable3159(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
