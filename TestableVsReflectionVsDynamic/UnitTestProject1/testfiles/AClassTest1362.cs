...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1362
    {
        ...
        private AClassTestable1362 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1362(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1362 : AClass
    {
        public AClassTestable1362(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
