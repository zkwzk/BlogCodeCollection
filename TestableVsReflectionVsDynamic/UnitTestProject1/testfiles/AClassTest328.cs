...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest328
    {
        ...
        private AClassTestable328 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable328(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable328 : AClass
    {
        public AClassTestable328(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
