...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest442
    {
        ...
        private AClassTestable442 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable442(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable442 : AClass
    {
        public AClassTestable442(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
