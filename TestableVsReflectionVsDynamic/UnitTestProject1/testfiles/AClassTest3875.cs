...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3875
    {
        ...
        private AClassTestable3875 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3875(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3875 : AClass
    {
        public AClassTestable3875(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
