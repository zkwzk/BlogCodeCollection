...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest204
    {
        ...
        private AClassTestable204 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable204(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable204 : AClass
    {
        public AClassTestable204(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
