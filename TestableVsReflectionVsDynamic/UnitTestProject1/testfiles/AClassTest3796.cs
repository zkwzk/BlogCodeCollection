...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3796
    {
        ...
        private AClassTestable3796 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3796(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3796 : AClass
    {
        public AClassTestable3796(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
