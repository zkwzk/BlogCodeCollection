...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1783
    {
        ...
        private AClassTestable1783 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1783(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1783 : AClass
    {
        public AClassTestable1783(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
