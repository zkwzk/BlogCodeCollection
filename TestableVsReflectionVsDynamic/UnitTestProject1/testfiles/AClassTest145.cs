...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest145
    {
        ...
        private AClassTestable145 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable145(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable145 : AClass
    {
        public AClassTestable145(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
