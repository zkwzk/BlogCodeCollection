...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest371
    {
        ...
        private AClassTestable371 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable371(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable371 : AClass
    {
        public AClassTestable371(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
