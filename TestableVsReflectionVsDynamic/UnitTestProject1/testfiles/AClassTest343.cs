...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest343
    {
        ...
        private AClassTestable343 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable343(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable343 : AClass
    {
        public AClassTestable343(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
