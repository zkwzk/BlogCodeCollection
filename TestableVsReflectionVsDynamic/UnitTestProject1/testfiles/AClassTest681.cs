...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest681
    {
        ...
        private AClassTestable681 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable681(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable681 : AClass
    {
        public AClassTestable681(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
