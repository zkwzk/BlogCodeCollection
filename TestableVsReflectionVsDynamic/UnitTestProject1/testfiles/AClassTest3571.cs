...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3571
    {
        ...
        private AClassTestable3571 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3571(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3571 : AClass
    {
        public AClassTestable3571(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
