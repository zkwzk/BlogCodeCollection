...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest837
    {
        ...
        private AClassTestable837 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable837(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable837 : AClass
    {
        public AClassTestable837(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
