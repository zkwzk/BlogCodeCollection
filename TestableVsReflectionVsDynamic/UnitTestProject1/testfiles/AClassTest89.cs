...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest89
    {
        ...
        private AClassTestable89 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable89(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable89 : AClass
    {
        public AClassTestable89(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
