...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest740
    {
        ...
        private AClassTestable740 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable740(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable740 : AClass
    {
        public AClassTestable740(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
