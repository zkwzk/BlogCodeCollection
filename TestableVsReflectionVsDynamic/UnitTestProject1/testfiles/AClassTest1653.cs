...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1653
    {
        ...
        private AClassTestable1653 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1653(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1653 : AClass
    {
        public AClassTestable1653(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
