...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest722
    {
        ...
        private AClassTestable722 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable722(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable722 : AClass
    {
        public AClassTestable722(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
