...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1704
    {
        ...
        private AClassTestable1704 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1704(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1704 : AClass
    {
        public AClassTestable1704(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
