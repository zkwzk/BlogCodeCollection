...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest2
    {
        ...
        private AClassTestable2 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable2(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable2 : AClass
    {
        public AClassTestable2(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
