...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3169
    {
        ...
        private AClassTestable3169 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3169(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3169 : AClass
    {
        public AClassTestable3169(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
