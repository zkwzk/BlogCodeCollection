...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest950
    {
        ...
        private AClassTestable950 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable950(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable950 : AClass
    {
        public AClassTestable950(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
