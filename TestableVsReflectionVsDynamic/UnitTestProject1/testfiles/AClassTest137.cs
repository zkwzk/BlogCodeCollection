...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest137
    {
        ...
        private AClassTestable137 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable137(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable137 : AClass
    {
        public AClassTestable137(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
