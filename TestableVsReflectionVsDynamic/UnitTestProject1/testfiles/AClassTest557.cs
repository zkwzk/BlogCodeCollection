...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest557
    {
        ...
        private AClassTestable557 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable557(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable557 : AClass
    {
        public AClassTestable557(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
