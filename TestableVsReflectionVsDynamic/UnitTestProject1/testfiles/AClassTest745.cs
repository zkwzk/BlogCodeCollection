...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest745
    {
        ...
        private AClassTestable745 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable745(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable745 : AClass
    {
        public AClassTestable745(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
