...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1715
    {
        ...
        private AClassTestable1715 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1715(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1715 : AClass
    {
        public AClassTestable1715(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
