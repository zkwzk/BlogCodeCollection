...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest815
    {
        ...
        private AClassTestable815 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable815(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable815 : AClass
    {
        public AClassTestable815(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
