...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest683
    {
        ...
        private AClassTestable683 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable683(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable683 : AClass
    {
        public AClassTestable683(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
