...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest330
    {
        ...
        private AClassTestable330 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable330(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable330 : AClass
    {
        public AClassTestable330(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
