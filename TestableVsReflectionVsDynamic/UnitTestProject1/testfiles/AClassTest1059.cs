...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1059
    {
        ...
        private AClassTestable1059 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1059(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1059 : AClass
    {
        public AClassTestable1059(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
