...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest544
    {
        ...
        private AClassTestable544 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable544(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable544 : AClass
    {
        public AClassTestable544(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
