...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1306
    {
        ...
        private AClassTestable1306 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1306(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1306 : AClass
    {
        public AClassTestable1306(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
