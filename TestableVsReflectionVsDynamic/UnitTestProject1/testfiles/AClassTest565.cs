...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest565
    {
        ...
        private AClassTestable565 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable565(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable565 : AClass
    {
        public AClassTestable565(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
