...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1865
    {
        ...
        private AClassTestable1865 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1865(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1865 : AClass
    {
        public AClassTestable1865(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
