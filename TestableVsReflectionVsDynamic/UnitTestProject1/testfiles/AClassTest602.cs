...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest602
    {
        ...
        private AClassTestable602 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable602(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable602 : AClass
    {
        public AClassTestable602(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
