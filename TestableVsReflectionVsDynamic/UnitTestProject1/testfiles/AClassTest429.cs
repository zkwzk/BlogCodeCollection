...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest429
    {
        ...
        private AClassTestable429 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable429(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable429 : AClass
    {
        public AClassTestable429(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
