...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3591
    {
        ...
        private AClassTestable3591 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3591(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3591 : AClass
    {
        public AClassTestable3591(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
