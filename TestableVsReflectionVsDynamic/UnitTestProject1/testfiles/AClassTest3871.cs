...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3871
    {
        ...
        private AClassTestable3871 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3871(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3871 : AClass
    {
        public AClassTestable3871(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
