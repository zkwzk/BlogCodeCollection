...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1725
    {
        ...
        private AClassTestable1725 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1725(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1725 : AClass
    {
        public AClassTestable1725(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
