...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest427
    {
        ...
        private AClassTestable427 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable427(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable427 : AClass
    {
        public AClassTestable427(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
