...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1845
    {
        ...
        private AClassTestable1845 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1845(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1845 : AClass
    {
        public AClassTestable1845(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
