...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1508
    {
        ...
        private AClassTestable1508 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1508(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1508 : AClass
    {
        public AClassTestable1508(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
