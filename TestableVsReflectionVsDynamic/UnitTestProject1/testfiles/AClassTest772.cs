...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest772
    {
        ...
        private AClassTestable772 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable772(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable772 : AClass
    {
        public AClassTestable772(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
