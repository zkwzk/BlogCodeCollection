...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest794
    {
        ...
        private AClassTestable794 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable794(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable794 : AClass
    {
        public AClassTestable794(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
