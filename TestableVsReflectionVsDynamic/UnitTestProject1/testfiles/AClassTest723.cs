...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest723
    {
        ...
        private AClassTestable723 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable723(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable723 : AClass
    {
        public AClassTestable723(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
