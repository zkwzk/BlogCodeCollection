...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest455
    {
        ...
        private AClassTestable455 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable455(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable455 : AClass
    {
        public AClassTestable455(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
