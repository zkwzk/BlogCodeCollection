...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1355
    {
        ...
        private AClassTestable1355 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1355(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1355 : AClass
    {
        public AClassTestable1355(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
