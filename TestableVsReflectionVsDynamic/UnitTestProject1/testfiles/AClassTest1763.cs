...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1763
    {
        ...
        private AClassTestable1763 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1763(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1763 : AClass
    {
        public AClassTestable1763(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
