...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest746
    {
        ...
        private AClassTestable746 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable746(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable746 : AClass
    {
        public AClassTestable746(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
