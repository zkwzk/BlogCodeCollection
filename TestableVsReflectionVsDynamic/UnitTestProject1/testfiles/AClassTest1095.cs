...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1095
    {
        ...
        private AClassTestable1095 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1095(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1095 : AClass
    {
        public AClassTestable1095(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
