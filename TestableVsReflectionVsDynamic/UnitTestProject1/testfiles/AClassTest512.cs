...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest512
    {
        ...
        private AClassTestable512 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable512(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable512 : AClass
    {
        public AClassTestable512(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
