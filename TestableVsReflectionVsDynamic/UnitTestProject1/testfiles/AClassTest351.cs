...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest351
    {
        ...
        private AClassTestable351 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable351(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable351 : AClass
    {
        public AClassTestable351(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
