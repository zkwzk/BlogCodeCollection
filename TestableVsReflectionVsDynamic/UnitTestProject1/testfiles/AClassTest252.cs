...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest252
    {
        ...
        private AClassTestable252 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable252(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable252 : AClass
    {
        public AClassTestable252(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
