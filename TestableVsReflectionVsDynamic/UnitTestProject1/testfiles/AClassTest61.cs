...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest61
    {
        ...
        private AClassTestable61 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable61(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable61 : AClass
    {
        public AClassTestable61(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
