...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest519
    {
        ...
        private AClassTestable519 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable519(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable519 : AClass
    {
        public AClassTestable519(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
