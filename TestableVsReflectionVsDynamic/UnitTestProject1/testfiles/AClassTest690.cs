...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest690
    {
        ...
        private AClassTestable690 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable690(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable690 : AClass
    {
        public AClassTestable690(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
