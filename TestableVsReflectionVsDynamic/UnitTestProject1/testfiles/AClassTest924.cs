...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest924
    {
        ...
        private AClassTestable924 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable924(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable924 : AClass
    {
        public AClassTestable924(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
