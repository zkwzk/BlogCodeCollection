...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3621
    {
        ...
        private AClassTestable3621 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3621(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3621 : AClass
    {
        public AClassTestable3621(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
