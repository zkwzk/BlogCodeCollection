...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest748
    {
        ...
        private AClassTestable748 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable748(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable748 : AClass
    {
        public AClassTestable748(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
