...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest767
    {
        ...
        private AClassTestable767 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable767(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable767 : AClass
    {
        public AClassTestable767(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
