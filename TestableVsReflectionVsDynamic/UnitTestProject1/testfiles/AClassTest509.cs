...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest509
    {
        ...
        private AClassTestable509 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable509(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable509 : AClass
    {
        public AClassTestable509(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
