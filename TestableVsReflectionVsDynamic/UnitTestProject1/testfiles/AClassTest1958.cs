...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1958
    {
        ...
        private AClassTestable1958 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1958(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1958 : AClass
    {
        public AClassTestable1958(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
