...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest912
    {
        ...
        private AClassTestable912 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable912(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable912 : AClass
    {
        public AClassTestable912(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
