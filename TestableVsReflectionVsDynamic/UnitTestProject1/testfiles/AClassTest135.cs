...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest135
    {
        ...
        private AClassTestable135 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable135(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable135 : AClass
    {
        public AClassTestable135(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
