...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest215
    {
        ...
        private AClassTestable215 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable215(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable215 : AClass
    {
        public AClassTestable215(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
