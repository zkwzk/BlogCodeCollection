...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest59
    {
        ...
        private AClassTestable59 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable59(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable59 : AClass
    {
        public AClassTestable59(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
