...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3174
    {
        ...
        private AClassTestable3174 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3174(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3174 : AClass
    {
        public AClassTestable3174(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
