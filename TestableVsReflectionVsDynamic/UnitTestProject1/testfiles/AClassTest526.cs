...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest526
    {
        ...
        private AClassTestable526 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable526(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable526 : AClass
    {
        public AClassTestable526(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
