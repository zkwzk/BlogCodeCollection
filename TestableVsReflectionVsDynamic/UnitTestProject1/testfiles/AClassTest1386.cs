...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1386
    {
        ...
        private AClassTestable1386 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1386(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1386 : AClass
    {
        public AClassTestable1386(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
