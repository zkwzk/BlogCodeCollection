...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3925
    {
        ...
        private AClassTestable3925 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3925(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3925 : AClass
    {
        public AClassTestable3925(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
