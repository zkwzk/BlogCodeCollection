...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1250
    {
        ...
        private AClassTestable1250 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1250(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1250 : AClass
    {
        public AClassTestable1250(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
