...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest904
    {
        ...
        private AClassTestable904 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable904(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable904 : AClass
    {
        public AClassTestable904(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
