...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1984
    {
        ...
        private AClassTestable1984 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1984(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1984 : AClass
    {
        public AClassTestable1984(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
