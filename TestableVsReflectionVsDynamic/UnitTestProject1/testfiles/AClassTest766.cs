...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest766
    {
        ...
        private AClassTestable766 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable766(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable766 : AClass
    {
        public AClassTestable766(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
