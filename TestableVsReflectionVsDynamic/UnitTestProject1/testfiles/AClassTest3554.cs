...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3554
    {
        ...
        private AClassTestable3554 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3554(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3554 : AClass
    {
        public AClassTestable3554(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
