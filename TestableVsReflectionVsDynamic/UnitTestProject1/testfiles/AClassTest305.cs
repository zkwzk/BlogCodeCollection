...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest305
    {
        ...
        private AClassTestable305 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable305(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable305 : AClass
    {
        public AClassTestable305(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
