...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest206
    {
        ...
        private AClassTestable206 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable206(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable206 : AClass
    {
        public AClassTestable206(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
