...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest465
    {
        ...
        private AClassTestable465 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable465(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable465 : AClass
    {
        public AClassTestable465(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
