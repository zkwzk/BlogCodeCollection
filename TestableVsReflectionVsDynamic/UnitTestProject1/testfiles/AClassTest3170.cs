...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3170
    {
        ...
        private AClassTestable3170 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3170(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3170 : AClass
    {
        public AClassTestable3170(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
