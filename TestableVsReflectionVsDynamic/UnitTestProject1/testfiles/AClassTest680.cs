...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest680
    {
        ...
        private AClassTestable680 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable680(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable680 : AClass
    {
        public AClassTestable680(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
