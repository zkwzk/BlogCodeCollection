...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1560
    {
        ...
        private AClassTestable1560 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1560(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1560 : AClass
    {
        public AClassTestable1560(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
