...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest883
    {
        ...
        private AClassTestable883 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable883(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable883 : AClass
    {
        public AClassTestable883(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
