...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest130
    {
        ...
        private AClassTestable130 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable130(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable130 : AClass
    {
        public AClassTestable130(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
