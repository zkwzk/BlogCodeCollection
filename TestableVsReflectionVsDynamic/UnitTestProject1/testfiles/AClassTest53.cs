...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest53
    {
        ...
        private AClassTestable53 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable53(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable53 : AClass
    {
        public AClassTestable53(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
