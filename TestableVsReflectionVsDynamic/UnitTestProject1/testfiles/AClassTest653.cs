...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest653
    {
        ...
        private AClassTestable653 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable653(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable653 : AClass
    {
        public AClassTestable653(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
