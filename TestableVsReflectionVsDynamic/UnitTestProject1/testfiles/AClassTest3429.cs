...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3429
    {
        ...
        private AClassTestable3429 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3429(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3429 : AClass
    {
        public AClassTestable3429(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
