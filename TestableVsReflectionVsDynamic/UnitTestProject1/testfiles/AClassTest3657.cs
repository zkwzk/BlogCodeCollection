...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3657
    {
        ...
        private AClassTestable3657 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3657(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3657 : AClass
    {
        public AClassTestable3657(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
