...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest307
    {
        ...
        private AClassTestable307 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable307(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable307 : AClass
    {
        public AClassTestable307(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
