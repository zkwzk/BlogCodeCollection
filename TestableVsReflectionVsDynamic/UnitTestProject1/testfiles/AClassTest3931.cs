...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3931
    {
        ...
        private AClassTestable3931 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3931(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3931 : AClass
    {
        public AClassTestable3931(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
