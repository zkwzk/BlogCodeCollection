...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest436
    {
        ...
        private AClassTestable436 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable436(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable436 : AClass
    {
        public AClassTestable436(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
