...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest104
    {
        ...
        private AClassTestable104 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable104(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable104 : AClass
    {
        public AClassTestable104(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
