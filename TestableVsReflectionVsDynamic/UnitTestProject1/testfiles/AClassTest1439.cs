...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1439
    {
        ...
        private AClassTestable1439 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1439(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1439 : AClass
    {
        public AClassTestable1439(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
