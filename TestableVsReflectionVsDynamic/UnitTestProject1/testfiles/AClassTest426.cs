...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest426
    {
        ...
        private AClassTestable426 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable426(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable426 : AClass
    {
        public AClassTestable426(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
