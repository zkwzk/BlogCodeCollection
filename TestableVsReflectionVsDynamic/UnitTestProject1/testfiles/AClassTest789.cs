...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest789
    {
        ...
        private AClassTestable789 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable789(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable789 : AClass
    {
        public AClassTestable789(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
