...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1507
    {
        ...
        private AClassTestable1507 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1507(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1507 : AClass
    {
        public AClassTestable1507(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
