...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest919
    {
        ...
        private AClassTestable919 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable919(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable919 : AClass
    {
        public AClassTestable919(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
