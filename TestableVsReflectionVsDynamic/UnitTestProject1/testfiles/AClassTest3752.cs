...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3752
    {
        ...
        private AClassTestable3752 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3752(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3752 : AClass
    {
        public AClassTestable3752(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
