...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest668
    {
        ...
        private AClassTestable668 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable668(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable668 : AClass
    {
        public AClassTestable668(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
