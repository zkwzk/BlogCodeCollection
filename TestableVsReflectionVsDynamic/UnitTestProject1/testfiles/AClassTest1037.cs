...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1037
    {
        ...
        private AClassTestable1037 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1037(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1037 : AClass
    {
        public AClassTestable1037(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
