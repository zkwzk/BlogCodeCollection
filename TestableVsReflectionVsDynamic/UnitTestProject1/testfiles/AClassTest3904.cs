...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3904
    {
        ...
        private AClassTestable3904 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3904(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3904 : AClass
    {
        public AClassTestable3904(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
