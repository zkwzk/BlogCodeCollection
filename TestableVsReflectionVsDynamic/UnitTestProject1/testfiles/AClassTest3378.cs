...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3378
    {
        ...
        private AClassTestable3378 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3378(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3378 : AClass
    {
        public AClassTestable3378(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
