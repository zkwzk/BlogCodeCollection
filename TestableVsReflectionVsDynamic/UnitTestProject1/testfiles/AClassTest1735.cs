...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1735
    {
        ...
        private AClassTestable1735 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1735(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1735 : AClass
    {
        public AClassTestable1735(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
