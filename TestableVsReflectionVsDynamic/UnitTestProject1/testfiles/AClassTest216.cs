...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest216
    {
        ...
        private AClassTestable216 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable216(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable216 : AClass
    {
        public AClassTestable216(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
