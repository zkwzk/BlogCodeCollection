...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1963
    {
        ...
        private AClassTestable1963 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1963(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1963 : AClass
    {
        public AClassTestable1963(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
