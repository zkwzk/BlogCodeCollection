...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest466
    {
        ...
        private AClassTestable466 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable466(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable466 : AClass
    {
        public AClassTestable466(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
