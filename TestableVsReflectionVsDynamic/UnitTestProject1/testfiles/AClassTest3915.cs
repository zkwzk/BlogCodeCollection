...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3915
    {
        ...
        private AClassTestable3915 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3915(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3915 : AClass
    {
        public AClassTestable3915(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
