...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest37
    {
        ...
        private AClassTestable37 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable37(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable37 : AClass
    {
        public AClassTestable37(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
