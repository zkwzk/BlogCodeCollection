...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3326
    {
        ...
        private AClassTestable3326 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3326(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3326 : AClass
    {
        public AClassTestable3326(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
