...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3840
    {
        ...
        private AClassTestable3840 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3840(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3840 : AClass
    {
        public AClassTestable3840(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
