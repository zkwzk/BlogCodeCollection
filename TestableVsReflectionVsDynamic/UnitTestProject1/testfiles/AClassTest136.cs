...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest136
    {
        ...
        private AClassTestable136 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable136(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable136 : AClass
    {
        public AClassTestable136(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
