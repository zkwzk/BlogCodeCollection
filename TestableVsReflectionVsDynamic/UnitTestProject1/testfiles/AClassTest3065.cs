...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3065
    {
        ...
        private AClassTestable3065 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3065(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3065 : AClass
    {
        public AClassTestable3065(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
