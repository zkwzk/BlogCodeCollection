...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest537
    {
        ...
        private AClassTestable537 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable537(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable537 : AClass
    {
        public AClassTestable537(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
