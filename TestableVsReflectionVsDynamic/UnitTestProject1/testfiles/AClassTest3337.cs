...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3337
    {
        ...
        private AClassTestable3337 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3337(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3337 : AClass
    {
        public AClassTestable3337(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
