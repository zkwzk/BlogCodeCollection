...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest368
    {
        ...
        private AClassTestable368 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable368(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable368 : AClass
    {
        public AClassTestable368(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
