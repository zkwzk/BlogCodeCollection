...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest951
    {
        ...
        private AClassTestable951 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable951(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable951 : AClass
    {
        public AClassTestable951(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
