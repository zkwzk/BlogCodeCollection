...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest558
    {
        ...
        private AClassTestable558 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable558(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable558 : AClass
    {
        public AClassTestable558(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
