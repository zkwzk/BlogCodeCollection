...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3067
    {
        ...
        private AClassTestable3067 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3067(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3067 : AClass
    {
        public AClassTestable3067(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
