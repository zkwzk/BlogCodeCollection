...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest308
    {
        ...
        private AClassTestable308 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable308(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable308 : AClass
    {
        public AClassTestable308(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
