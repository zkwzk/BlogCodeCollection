...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest704
    {
        ...
        private AClassTestable704 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable704(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable704 : AClass
    {
        public AClassTestable704(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
