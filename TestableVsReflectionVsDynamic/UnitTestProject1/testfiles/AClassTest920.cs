...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest920
    {
        ...
        private AClassTestable920 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable920(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable920 : AClass
    {
        public AClassTestable920(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
