...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3624
    {
        ...
        private AClassTestable3624 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3624(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3624 : AClass
    {
        public AClassTestable3624(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
