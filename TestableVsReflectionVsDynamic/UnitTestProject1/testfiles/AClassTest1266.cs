...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1266
    {
        ...
        private AClassTestable1266 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1266(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1266 : AClass
    {
        public AClassTestable1266(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
