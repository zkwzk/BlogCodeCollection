...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3926
    {
        ...
        private AClassTestable3926 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3926(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3926 : AClass
    {
        public AClassTestable3926(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
