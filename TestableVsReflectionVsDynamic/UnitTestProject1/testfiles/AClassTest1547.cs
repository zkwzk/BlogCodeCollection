...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1547
    {
        ...
        private AClassTestable1547 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1547(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1547 : AClass
    {
        public AClassTestable1547(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
