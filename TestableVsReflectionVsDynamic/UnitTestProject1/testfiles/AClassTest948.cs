...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest948
    {
        ...
        private AClassTestable948 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable948(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable948 : AClass
    {
        public AClassTestable948(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
