...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3074
    {
        ...
        private AClassTestable3074 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3074(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3074 : AClass
    {
        public AClassTestable3074(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
