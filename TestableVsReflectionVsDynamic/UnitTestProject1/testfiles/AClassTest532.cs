...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest532
    {
        ...
        private AClassTestable532 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable532(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable532 : AClass
    {
        public AClassTestable532(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
