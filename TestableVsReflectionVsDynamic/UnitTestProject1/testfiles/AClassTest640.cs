...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest640
    {
        ...
        private AClassTestable640 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable640(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable640 : AClass
    {
        public AClassTestable640(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
