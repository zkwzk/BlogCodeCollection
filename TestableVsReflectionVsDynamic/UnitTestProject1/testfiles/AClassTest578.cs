...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest578
    {
        ...
        private AClassTestable578 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable578(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable578 : AClass
    {
        public AClassTestable578(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
