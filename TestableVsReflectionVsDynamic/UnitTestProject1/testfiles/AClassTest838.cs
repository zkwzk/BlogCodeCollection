...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest838
    {
        ...
        private AClassTestable838 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable838(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable838 : AClass
    {
        public AClassTestable838(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
