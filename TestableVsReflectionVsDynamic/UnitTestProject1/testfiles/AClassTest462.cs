...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest462
    {
        ...
        private AClassTestable462 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable462(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable462 : AClass
    {
        public AClassTestable462(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
