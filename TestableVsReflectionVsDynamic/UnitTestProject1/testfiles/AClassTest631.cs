...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest631
    {
        ...
        private AClassTestable631 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable631(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable631 : AClass
    {
        public AClassTestable631(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
