...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1785
    {
        ...
        private AClassTestable1785 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1785(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1785 : AClass
    {
        public AClassTestable1785(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
