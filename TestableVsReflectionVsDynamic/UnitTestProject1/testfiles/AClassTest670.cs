...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest670
    {
        ...
        private AClassTestable670 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable670(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable670 : AClass
    {
        public AClassTestable670(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
