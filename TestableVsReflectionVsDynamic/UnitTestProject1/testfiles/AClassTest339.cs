...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest339
    {
        ...
        private AClassTestable339 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable339(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable339 : AClass
    {
        public AClassTestable339(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
