...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1732
    {
        ...
        private AClassTestable1732 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1732(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1732 : AClass
    {
        public AClassTestable1732(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
