...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest16
    {
        ...
        private AClassTestable16 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable16(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable16 : AClass
    {
        public AClassTestable16(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
