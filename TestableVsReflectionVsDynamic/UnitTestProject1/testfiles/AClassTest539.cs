...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest539
    {
        ...
        private AClassTestable539 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable539(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable539 : AClass
    {
        public AClassTestable539(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
