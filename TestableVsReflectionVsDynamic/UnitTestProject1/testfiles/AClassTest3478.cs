...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3478
    {
        ...
        private AClassTestable3478 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3478(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3478 : AClass
    {
        public AClassTestable3478(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
