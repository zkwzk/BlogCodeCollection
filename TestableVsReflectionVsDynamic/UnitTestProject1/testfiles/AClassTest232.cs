...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest232
    {
        ...
        private AClassTestable232 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable232(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable232 : AClass
    {
        public AClassTestable232(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
