...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3999
    {
        ...
        private AClassTestable3999 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3999(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3999 : AClass
    {
        public AClassTestable3999(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
