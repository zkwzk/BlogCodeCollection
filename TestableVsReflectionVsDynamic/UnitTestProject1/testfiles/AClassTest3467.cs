...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3467
    {
        ...
        private AClassTestable3467 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3467(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3467 : AClass
    {
        public AClassTestable3467(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
