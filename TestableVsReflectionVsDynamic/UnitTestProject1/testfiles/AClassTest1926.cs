...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1926
    {
        ...
        private AClassTestable1926 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1926(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1926 : AClass
    {
        public AClassTestable1926(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
