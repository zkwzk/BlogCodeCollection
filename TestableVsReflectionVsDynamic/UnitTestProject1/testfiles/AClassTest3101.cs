...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3101
    {
        ...
        private AClassTestable3101 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3101(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3101 : AClass
    {
        public AClassTestable3101(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
