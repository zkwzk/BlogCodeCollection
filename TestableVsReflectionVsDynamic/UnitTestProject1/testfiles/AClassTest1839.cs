...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1839
    {
        ...
        private AClassTestable1839 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1839(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1839 : AClass
    {
        public AClassTestable1839(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
