...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1465
    {
        ...
        private AClassTestable1465 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1465(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1465 : AClass
    {
        public AClassTestable1465(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
