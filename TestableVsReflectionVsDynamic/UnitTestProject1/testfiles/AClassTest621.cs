...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest621
    {
        ...
        private AClassTestable621 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable621(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable621 : AClass
    {
        public AClassTestable621(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
