...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1752
    {
        ...
        private AClassTestable1752 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1752(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1752 : AClass
    {
        public AClassTestable1752(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
