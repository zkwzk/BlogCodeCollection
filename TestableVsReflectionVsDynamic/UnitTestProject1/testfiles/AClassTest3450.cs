...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3450
    {
        ...
        private AClassTestable3450 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3450(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3450 : AClass
    {
        public AClassTestable3450(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
