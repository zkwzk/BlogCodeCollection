...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest956
    {
        ...
        private AClassTestable956 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable956(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable956 : AClass
    {
        public AClassTestable956(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
