...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3692
    {
        ...
        private AClassTestable3692 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3692(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3692 : AClass
    {
        public AClassTestable3692(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
