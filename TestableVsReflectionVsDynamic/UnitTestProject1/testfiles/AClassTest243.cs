...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest243
    {
        ...
        private AClassTestable243 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable243(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable243 : AClass
    {
        public AClassTestable243(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
