...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3048
    {
        ...
        private AClassTestable3048 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3048(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3048 : AClass
    {
        public AClassTestable3048(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
