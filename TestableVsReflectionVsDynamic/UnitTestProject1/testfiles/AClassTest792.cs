...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest792
    {
        ...
        private AClassTestable792 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable792(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable792 : AClass
    {
        public AClassTestable792(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
