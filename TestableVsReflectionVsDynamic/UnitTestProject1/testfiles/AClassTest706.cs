...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest706
    {
        ...
        private AClassTestable706 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable706(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable706 : AClass
    {
        public AClassTestable706(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
