...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1058
    {
        ...
        private AClassTestable1058 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1058(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1058 : AClass
    {
        public AClassTestable1058(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
