...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1883
    {
        ...
        private AClassTestable1883 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1883(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1883 : AClass
    {
        public AClassTestable1883(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
