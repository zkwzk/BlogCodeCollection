...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1953
    {
        ...
        private AClassTestable1953 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1953(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1953 : AClass
    {
        public AClassTestable1953(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
