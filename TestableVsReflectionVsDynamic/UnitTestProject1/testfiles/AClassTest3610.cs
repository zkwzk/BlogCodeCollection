...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3610
    {
        ...
        private AClassTestable3610 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3610(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3610 : AClass
    {
        public AClassTestable3610(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
