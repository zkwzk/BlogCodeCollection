...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1875
    {
        ...
        private AClassTestable1875 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1875(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1875 : AClass
    {
        public AClassTestable1875(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
