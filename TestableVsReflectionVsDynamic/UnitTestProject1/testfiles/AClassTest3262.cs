...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3262
    {
        ...
        private AClassTestable3262 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3262(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3262 : AClass
    {
        public AClassTestable3262(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
