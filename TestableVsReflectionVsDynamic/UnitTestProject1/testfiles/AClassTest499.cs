...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest499
    {
        ...
        private AClassTestable499 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable499(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable499 : AClass
    {
        public AClassTestable499(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
