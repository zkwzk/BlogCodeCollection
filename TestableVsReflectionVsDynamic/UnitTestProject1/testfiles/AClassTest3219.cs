...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3219
    {
        ...
        private AClassTestable3219 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3219(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3219 : AClass
    {
        public AClassTestable3219(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
