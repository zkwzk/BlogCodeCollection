...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1357
    {
        ...
        private AClassTestable1357 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1357(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1357 : AClass
    {
        public AClassTestable1357(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
