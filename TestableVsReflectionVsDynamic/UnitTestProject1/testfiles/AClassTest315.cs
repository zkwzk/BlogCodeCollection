...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest315
    {
        ...
        private AClassTestable315 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable315(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable315 : AClass
    {
        public AClassTestable315(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
