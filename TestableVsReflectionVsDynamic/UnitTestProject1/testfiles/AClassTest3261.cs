...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest3261
    {
        ...
        private AClassTestable3261 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable3261(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable3261 : AClass
    {
        public AClassTestable3261(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
