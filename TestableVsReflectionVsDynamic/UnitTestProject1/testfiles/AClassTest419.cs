...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest419
    {
        ...
        private AClassTestable419 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable419(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable419 : AClass
    {
        public AClassTestable419(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
