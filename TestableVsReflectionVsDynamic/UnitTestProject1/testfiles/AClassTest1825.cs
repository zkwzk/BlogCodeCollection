...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest1825
    {
        ...
        private AClassTestable1825 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable1825(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable1825 : AClass
    {
        public AClassTestable1825(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
