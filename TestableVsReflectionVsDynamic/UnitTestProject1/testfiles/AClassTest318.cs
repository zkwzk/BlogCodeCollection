...
namespace UnitTestTestableProject
{
    ...
    public class AClassTest318
    {
        ...
        private AClassTestable318 target;
        ...
        public void Setup()
        {
            ...
            target = new AClassTestable318(MockA.Object, MockB.Object, MockC.Object);
        }
    ...
    public class AClassTestable318 : AClass
    {
        public AClassTestable318(IA a, IB b, IC c)
        {
            A = a;
            B = b;
            C = c;
